...
1. Получите строку подключения. На странице группы серверов щелкните пункт меню **Строки подключения** (Он находится в разделе **Параметры**.) Найдите строку, помеченную как **psql**. Значение будет представлено в формате:
