...
| Внутренние ресурсы на Load Balancer<sup>1<sup> | 1200                   |
...
<sup>1</sup> Ограничение составляет до 1200 ресурсов; допускаются любые сочетания ресурсов отдельных виртуальных машин и наборов доступности, а также групп размещения масштабируемых наборов виртуальных машин.
