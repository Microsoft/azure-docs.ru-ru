...
![Приложение отправляет запрос с пропускной способностью 15 МБ/с для виртуальной машины, виртуальная машина принимает запрос и отправляет каждый из своих дисков запрос на 5 МБ/с, каждый диск возвращает 5 МБ/с. для приложения виртуальная машина возвращает 15 МБ/с.](media/managed-disks-bursting/bursting-vm-bursting-disk/burst-vm-burst-disk-idling.jpg)
