...
1. Нажмите кнопку **OK**. Запускается конфигурация устройства. После завершения конфигурации устройства вы получите уведомление. В колонке **устройств** состояние устройства изменится на **Подключено**.
