...
Учетную запись хранения Azure можно создать также с помощью [Azure PowerShell](/powershell/module/az.storage/) или [Azure CLI](../articles/storage/blobs/storage-quickstart-blobs-cli.md).
