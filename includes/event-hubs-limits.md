...
|---|---|--|---|
| Максимальный размер публикации Центров событий| &nbsp; | 256 KB | 1 МБ |
...
| Число разделов на концентратор событий | |32 | 32 | 

> [!NOTE]
>
> Можно публиковать события по отдельности или в пакетном режиме. 
> Ограничение на публикацию (в соответствии с SKU) применяется независимо от того, отдельное ли это событие или пакет. События публикации, превышающие максимальное пороговое значение, будут отклонены.
