...
ms.locfileid: "99493495"
---
+ [Группа ресурсов](../articles/azure-resource-manager/management/overview.md) — логический контейнер связанных ресурсов.
+ [Учетная запись хранения Azure](../articles/storage/common/storage-account-create.md) уровня "Стандартный" для сохранения состояния и других сведений о проектах.
