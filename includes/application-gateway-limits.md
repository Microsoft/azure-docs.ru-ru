...
| Одновременные подключения WebSocket |Средние шлюзы, 20 тыс.<sup>2</sup><br> Крупные шлюзы, 50 тыс.<sup>2</sup>| |
...
<sup>2</sup> Ограничение задается для экземпляра Шлюза приложений, а не для ресурса Шлюза приложений.
