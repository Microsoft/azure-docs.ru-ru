...
| Глобальное распределение | Один регион с отдельным необязательным регионом вторичных реплик для чтения для высокой доступности, который поддерживает автоматическую и ручную отработку отказа учетной записи. | [Комплексные возможности глобального распределения](../articles/cosmos-db/distribute-data-globally.md) для 30 и более регионов. Поддержка [автоматической отработки отказа и отработки отказа вручную](../articles/cosmos-db/high-availability.md) в любое время повсеместно. |
