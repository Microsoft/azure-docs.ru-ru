...
>
> Последние обновления доступны в [заметках о выпуске](../articles/azure-arc/data/release-notes.md).
>
...
>
> Дополнительные ограничения и дополнительные сведения см. в описании [известных проблем](../articles/azure-arc/data/known-issues.md).