...
* Создавайте приложения логики и их рабочие процессы из [400 соединителей](/connectors/connector-reference/connector-reference-logicapps-connectors) для приложений и служб типа "программное обеспечение как услуга" (PaaS) и "платформа как услуга", а также соединителей для локальных систем.
  ...
  * Некоторые управляемые соединители, такие как служебная шина Azure, концентраторы событий Azure, SQL Server и MQ, выполняются аналогично встроенным триггерам и действиям, которые являются собственными для среды выполнения Azure Logic Apps Preview, например триггером запроса и действием HTTP.
...
* Добавьте в новый конструктор параллельные ветви, выполнив те же действия, что и в конструкторе, отличном от Preview.
