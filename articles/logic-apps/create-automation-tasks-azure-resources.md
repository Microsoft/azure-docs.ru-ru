...
1. В области **Добавить задачу** в разделе **Выбор шаблона** выберите шаблон для задачи, которую требуется создать. Если Следующая страница не отображается, нажмите кнопку **Далее: проверка подлинности**.
