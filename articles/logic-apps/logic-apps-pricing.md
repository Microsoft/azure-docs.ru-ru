...
Azure Logic Apps предлагает такие уровни учетных записей интеграции или уровней, которые [различаются по ценам](https://azure.microsoft.com/pricing/details/logic-apps/) и [модели выставления счетов](logic-apps-pricing.md#integration-accounts)в зависимости от того, работают ли приложения логики на основе использования или интегрированной среды сценариев.
...
| **Стандартный** | Для сценариев, в которых имеются более сложные отношения B2B и увеличено количество сущностей, которыми необходимо управлять. <p><p>Поддерживается Logic Apps SLA. |
