...
1. Создайте контейнер хранилища BLOB-объектов для вложений электронной почты.
   ...
   Контейнер хранилища также можно создать с помощью [Azure PowerShell](/powershell/module/az.storage/new-azstoragecontainer) или [Azure CLI](/cli/azure/storage/container#az_storage_container_create).
