...
| Имя | Ограничение | Примечания |
| ---- | ----- | ----- |
| Действие: выполнений за 5-минутный интервал | -100 000 выполнений (по умолчанию) <p><p>-300 000 выполнений (максимум в режиме высокой пропускной способности)  | Чтобы увеличить ограничение по умолчанию до максимального ограничения для приложения логики, см. раздел [Запуск в режиме высокой пропускной способности](#run-high-throughput-mode), который находится на этапе предварительной версии. Кроме того, при необходимости можно [распределить рабочую нагрузку по нескольким приложениям логики](../logic-apps/handle-throttling-problems-429-errors.md#logic-app-throttling) . |
...
Для одного определения приложения логики количество действий, выполняемых каждые 5 минут, имеет [ограничение по умолчанию](../logic-apps/logic-apps-limits-and-config.md#throughput-limits). Чтобы увеличить ограничение по умолчанию до [максимального ограничения](../logic-apps/logic-apps-limits-and-config.md#throughput-limits) для приложения логики, которое в три раза превышает ограничение по умолчанию, можно включить режим высокой пропускной способности, который находится на этапе предварительной версии. Кроме того, при необходимости можно [распределить рабочую нагрузку по нескольким приложениям логики](../logic-apps/handle-throttling-problems-429-errors.md#logic-app-throttling) .
...
| Юго-Восточная Бразилия | 20.40.32.59, 20.40.32.162, 20.40.32.80, 20.40.32.49 |
...
| Юго-Восточная Бразилия | 20.40.32.81, 20.40.32.19, 20.40.32.85, 20.40.32.60, 20.40.32.116, 20.40.32.87, 20.40.32.61, 20.40.32.113 | 23.97.120.109, 23.97.121.26 |
