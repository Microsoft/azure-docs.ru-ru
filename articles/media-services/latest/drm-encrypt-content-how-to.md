...
* [Динамическое шифрование и доставка ключей](drm-content-protection-concept.md)
...
* [Политики ключа содержимого](drm-content-key-policy-concept.md)
...
![Создание политики ключа содержимого](./media/drm-encrypt-content-how-to/create-content-key-policy.png)

Если вы выберете хотя бы один из вариантов (DRM или незащищенный ключ AES-128), вам будет предложено выбрать способ настройки ограничений. Можно установить ограничение "открытого типа" или "по маркеру". Подробное описание см. в разделе [Управление доступом к содержимому](drm-content-protection-concept.md#controlling-content-access).
...
* [Шаблон лицензии Google Widevine](drm-widevine-license-template-concept.md)
...
* [Требования и конфигурация лицензии Apple FairPlay](drm-fairplay-license-overview.md)
* [Шаблон лицензии PlayReady](drm-playready-license-template-concept.md)
...
![Незащищенный ключ AES](./media/drm-encrypt-content-how-to/aes-clear-key-policy.png)
...
1. Выберите **политику потоковой передачи**, которая лучше всего подходит для настроенной **политики ключа содержимого**.
    ...
    В статье [Политики потоковой передачи](stream-streaming-policy-concept.md) есть сведения о том, какая политика потоковой передачи соответствует политике ключа содержимого.
...
![Указатель потоковой передачи](./media/drm-encrypt-content-how-to/multi-drm.png)
