...
| управляемые удостоверения. | Управляемые удостоверения устраняют необходимость в управлении учетными данными разработчиками, предоставляя удостоверение для ресурса Azure в Azure AD. Дополнительные сведения об управляемых удостоверениях см. [здесь](../../active-directory/managed-identities-azure-resources/overview.md). |
