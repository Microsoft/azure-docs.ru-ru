...
Если вы не знаете, как получить идентификаторы клиента и подписки, см. [эту статью](setup-azure-tenant-how-to.md), чтобы [найти идентификатор клиента](setup-azure-tenant-how-to.md).
...
[Как создать ресурс](asset-create-asset-how-to.md)
