...
Вы можете использовать встроенную предустановку кодирования или пользовательскую предустановку. Дополнительные сведения см. в разделе [How to customize encoder presets](encode-custom-presets-how-to.md) (Настройка предустановки кодировщика).
