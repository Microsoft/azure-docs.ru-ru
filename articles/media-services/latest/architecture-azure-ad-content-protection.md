...
Утверждение *groups* является членом [набора ограниченных утверждений](../../active-directory/develop/reference-claims-mapping-policy-type.md#claim-sets) в Azure AD.
