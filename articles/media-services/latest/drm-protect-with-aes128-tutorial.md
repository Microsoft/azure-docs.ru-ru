...
Каждый ресурс можно зашифровать с помощью нескольких типов шифрования (AES-128, PlayReady, Widevine, FairPlay). Чтобы понять, что лучше объединять, см. раздел [Протоколы потоковой передачи и типы шифрования](drm-content-protection-concept.md#streaming-protocols-and-encryption-types). Ознакомьтесь также со статьей [Учебник. Использование динамического шифрования DRM и службы доставки лицензий](drm-protect-with-drm-tutorial.md).
...
> [Защита с помощью DRM](drm-protect-with-drm-tutorial.md)
