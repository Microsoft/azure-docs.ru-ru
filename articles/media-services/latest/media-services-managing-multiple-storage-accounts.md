---
title: Управление ресурсами служб мультимедиа v3 в нескольких учетных записях хранения | Документация Майкрософт
description: В этой статье содержатся рекомендации по управлению ресурсами служб мультимедиа v3 в нескольких учетных записях хранения.
...
ms.locfileid: "105572550"
---
# <a name="managing-media-services-v3-assets-across-multiple-storage-accounts"></a>Управление ресурсами служб мультимедиа v3 в нескольких учетных записях хранения  
