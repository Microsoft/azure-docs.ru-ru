...
description: В этой статье приводятся общие сведения о предустановленной задаче Media Encoder Standard H264 Single bitrate односкоростной 720p.
