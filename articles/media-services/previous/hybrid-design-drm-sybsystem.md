...
---
# <a name="hybrid-design-of-drm-subsystems"></a>Гибридная структура подсистемы управления цифровыми правами
...
|**Размещение содержимого и источник**|**Шифрование DRM**|**Доставка лицензий DRM**|**Настройка ключа содержимого**|**Настройка политики доставки для ресурса-контейнера**|**Образец**|
|---|---|---|---|---|---|
