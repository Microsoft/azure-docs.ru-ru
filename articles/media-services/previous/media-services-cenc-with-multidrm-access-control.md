...
![Снимок экрана: настраиваемая страница входа личного домена клиента Azure AD.](./media/media-services-cenc-with-multidrm-access-control/media-services-ad-tenant-domain1.png)
...
![Снимок экрана: страница входа, настроенная ИТ-специалистами корпорации Майкрософт, с двухфакторной проверкой подлинности.](./media/media-services-cenc-with-multidrm-access-control/media-services-ad-tenant-domain2.png)
