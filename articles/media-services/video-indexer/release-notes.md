...
Теперь функция "анализ звука" доступна в дополнительном новом наборе звуковых функций с разными ценовыми точками. Новая базовая конфигурация "анализ **звука** " — это недорогой вариант, позволяющий только извлекать субтитры, перевод и форматирование выходных данных и субтитров. Базовая Предустановка **аудио** будет создавать два отдельных счетчика на счете, включая строку для транскрипции и отдельную строку для форматирования заголовка и подзаголовка. Дополнительные сведения о ценах см. на странице [цен на службы мультимедиа](https://azure.microsoft.com/pricing/details/media-services/) .

Добавленный пакет доступен при индексировании или повторном индексировании файла путем выбора предварительной настройки **расширенного режима "Стандартный"** для  ->  **звука** (в раскрывающемся списке " **видео и индексирование звука** ").
