...
* Локальные агенты и параметры брандмауэра работают как есть. Вносить изменения не нужно. Log Analytics агенты, установленные на виртуальных машинах Azure, необходимо заменить [расширением наблюдателя за сетями](../virtual-machines/extensions/network-watcher-windows.md).
