...
Эта функция включается с помощью свойства **Автоматическое удаление при простое** в пространстве имен. Для этого свойства задается значение времени, в течение которого сущность должна быть неактивной (не использоваться) и по истечении которого она автоматически удаляется. Минимальное значение этого свойства — 5 минут.
