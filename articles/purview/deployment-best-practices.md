...
Вполне вероятно, что в зрелой Организации уже есть каталог данных. Ключевой вопрос состоит в том, следует ли продолжать использовать существующую технологию и выполнять синхронизацию с зрения. Для синхронизации с существующими продуктами в организации зрения предоставляет интерфейсы API для Atlas. API-интерфейсы Atlas предоставляют мощный и гибкий механизм, позволяющий обрабатывать как сценарии push-уведомлений, так и методы опроса. Сведения можно опубликовать в зрения с помощью API-интерфейсов Atlas для начальной загрузки или отправить последние обновления из другой системы в зрения. Сведения, доступные в зрения, можно также читать с помощью API-интерфейсов Atlas, а затем синхронизировать их с существующими продуктами. 
