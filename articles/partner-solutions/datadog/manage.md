...
- Достигнуто ограничение в 5 параметров диагностики. Каждый ресурс Azure может иметь не более пяти параметров диагностики. Дополнительные сведения см. в разделе [параметры диагностики](../../azure-monitor/essentials/diagnostic-settings.md).
