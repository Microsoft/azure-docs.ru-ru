---
title: Формат телеметрии издателя Microsoft OPC
description: В этой статье представлен обзор файла параметров конфигурации.
author: jehona-m
ms.author: jemorina
...
ms.locfileid: "104787585"
---
# <a name="opc-publisher-telemetry-format"></a>Формат телеметрии издателя OPC

Издатель OPC версии 2,6 и выше поддерживает стандартизированный формат OPC UA PubSub JSON, как указано в [части 14 спецификации OPC UA](https://opcfoundation.org/developer-tools/specifications-unified-architecture/part-14-pubsub/) , и выглядит следующим образом:
```
{
  "MessageId": "18",
  "MessageType": "ua-data",
...
Кроме того, все версии издателя OPC поддерживают нестандартизированный, простой формат телеметрии JSON, совместимый со службой " [аналитика временных рядов Azure](https://azure.microsoft.com/services/time-series-insights/) ", и выглядит следующим образом:
```
[
   {
...
## <a name="opc-publisher-telemetry-configuration-file-format"></a>Формат файла конфигурации телеметрии издателя OPC
```
