...
- Проанализируйте сведения о потреблении, чтобы определить, какие резервирования следует приобрести. Убедитесь, что вы следите за использованием в номерах дисков, а не подготовленных или используемых дисковых мощностях.
