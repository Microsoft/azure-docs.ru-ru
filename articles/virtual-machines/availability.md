...
**Режимы оркестрации для масштабируемых наборов**

Режимы оркестрации масштабируемых наборов виртуальных машин позволяют лучше контролировать управление экземплярами виртуальных машин с помощью масштабируемого набора. В масштабируемом наборе можно включить универсальный или гибкий режим оркестрации. Единое согласование оптимизировано для крупномасштабных рабочих нагрузок без отслеживания состояния с идентичными экземплярами. Гибкое согласование (Предварительная версия) предназначено для обеспечения высокой доступности в масштабе с одинаковыми или несколькими типами виртуальных машин. Дополнительные сведения об этих [режимах оркестрации](../virtual-machine-scale-sets/virtual-machine-scale-sets-orchestration-modes.md) и их включении.
