...
> [!NOTE]
> Чтобы получить расширенные функции безопасности, подготовьтесь к обновлению систем Ubuntu-1604 и Debian-9, так как эти версии достигли конца назначенного периода поддержки.
> 
