...
**Сообщение**: *набор шифрования диска <дискенкриптионсетид \> в общей коллекции образов <versionId \> принадлежит к подписке <subscriptionId1 \> и не может использоваться с ресурсом "" в подписке <subscriptionId2 \>*  
