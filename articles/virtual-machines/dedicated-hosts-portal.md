...
1. В поле поиска над списком ресурсов Azure Marketplace найдите и выберите нужный образ, а затем щелкните **Создать**.
...
1. Когда появится сообщение об успешной проверке, выберите **Создать**.
