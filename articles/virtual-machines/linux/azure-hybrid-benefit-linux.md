...
## <a name="azure-hybrid-benefit-on-reserved-instances-is-in-preview"></a>Преимущество гибридного использования Azure на зарезервированных экземплярах находится на этапе предварительной версии

Резервирование Azure (Azure Reserved Virtual Machine Instances) помогает экономить деньги за счет фиксации в одном или трех годах для нескольких продуктов. Дополнительные сведения о [зарезервированных экземплярах](https://docs.microsoft.com/azure/cost-management-billing/reservations/save-compute-costs-reservations)см. здесь. Преимущество гибридного использования Azure доступен в предварительной версии для [зарезервированного экземпляра виртуальной машины (RIS)](https://review.docs.microsoft.com/azure/cost-management-billing/reservations/save-compute-costs-reservations#charges-covered-by-reservation). Это означает, что если вы приобрели стоимость вычислений со скидкой, используя RI, вы можете применить АХБ преимущество на стоимость лицензирования для RHEL и SUSE поверх него. Действия по применению преимущества АХБ для экземпляра RI сохраняются точно так же, как для обычной виртуальной машины.
![АХБ для RIs](./media/azure-hybrid-benefit/reserved-instances.png)

>[!NOTE]
>Если вы уже приобрели резервирования для RHEL или SUSE PAYG Software в Azure Marketplace, дождитесь завершения резервирования пребывания, прежде чем использовать Преимущество гибридного использования Azure...
...
Ответ. Да, Преимущество гибридного использования Azure в масштабируемых наборах виртуальных машин для RHEL и SLES находится на этапе предварительной версии. [Дополнительные сведения об этом преимуществах и способах его использования см. здесь](https://docs.microsoft.com/azure/virtual-machine-scale-sets/azure-hybrid-benefit-linux-vmss). 

*Вопрос. можно ли использовать Преимущество гибридного использования Azure в зарезервированных экземплярах для RHEL и SLES?*

Ответ. Да, Преимущество гибридного использования Azure на зарезервированном экземпляре для RHEL и SLES находится на этапе предварительной версии. [Дополнительные сведения об этом преимуществах и способах его использования см. здесь](#azure-hybrid-benefit-on-reserved-instances-is-in-preview).
