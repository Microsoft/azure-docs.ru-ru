...
1. В колонке **диски** справа от диска данных, который вы хотите отключить, нажмите кнопку **X** , чтобы отключить диск.
1. После удаления диска выберите **сохранить** в верхней части колонки.
