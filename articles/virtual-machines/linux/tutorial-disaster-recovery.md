...
1. [Создайте виртуальную машину Linux](quick-create-portal.md).
2. На вкладке **Управление** в разделе **Site Recovery** выберите **Включить аварийное восстановление**.
...
6. В поле **Политика Site Recovery** оставьте политику по умолчанию или выберите **Создать**, чтобы задать пользовательские значения.
    ...
    - Моментальный снимок с согласованием приложений создается каждые 4 часа.
...
7. В области **Параметры доступности** укажите, следует ли развертывать виртуальную машину как автономную, в зоне доступности или в группе доступности.
    ...
    :::image type="content" source="./media/tutorial-disaster-recovery/create-vm.png" alt-text="Включите репликацию на странице свойств управления виртуальной машиной.":::
...
Если вы хотите включить аварийное восстановление для существующей виртуальной машины, используйте эту процедуру.
