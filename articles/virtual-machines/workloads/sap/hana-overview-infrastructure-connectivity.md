...
- Для каждого региона развертывания Azure:
    ...
    - При использовании [Global REACH ExpressRoute](../../../expressroute/expressroute-global-reach.md) для прямой маршрутизации из локальной среды в единицы крупных экземпляров Hana или между единицами крупных экземпляров Hana в разных регионах Azure нужно зарезервировать еще один дополнительный диапазон IP-адресов с маской /29. Этот диапазон не должен пересекаться с любыми другими диапазонами IP-адресов, определенными ранее.
