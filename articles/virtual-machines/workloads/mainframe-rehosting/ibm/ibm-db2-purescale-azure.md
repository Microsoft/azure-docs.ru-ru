...
Каждая виртуальная машина Azure развертывается в виртуальной сети, с подсетями: основной сетью, интерфейсной сетью Gluster FS (gfsfe), фоновой сетью Gluster FS (bfsbe), DB2 pureScale (db2be) и интерфейсной сетью DB2 pureScale (db2fe). Скрипт установки также создает основные [сетевые адаптеры](../../../windows/multiple-nics.md) на виртуальных машинах в основной подсети.
