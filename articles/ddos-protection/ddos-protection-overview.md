...
Стандарт защиты от атак DDoS предназначен для [служб, развернутых в виртуальной сети](../virtual-network/virtual-network-for-azure-services.md). Для остальных служб применяется "Защита от атак DDoS" уровня "Базовый". Дополнительные сведения о поддерживаемых архитектурах см. в разделе [эталонные архитектуры защиты от атак DDoS](./ddos-protection-reference-architectures.md). 
