...
> [!div class="checklist"]
> * Настройка оповещений через Azure Monitor
> * Настройка оповещений через портал
...
## <a name="configure-alerts-through-azure-monitor"></a>Настройка оповещений через Azure Monitor
...
## <a name="configure-alerts-through-portal"></a>Настройка оповещений через портал
