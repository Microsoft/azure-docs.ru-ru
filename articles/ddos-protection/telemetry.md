...
Для стандарта защиты Azure от атак DDoS доступны следующие [метрики](../azure-monitor/essentials/metrics-supported.md#microsoftnetworkpublicipaddresses) . Эти метрики также можно экспортировать с помощью параметров диагностики (см. раздел [Просмотр и Настройка ведения журнала диагностики от атак DDoS](diagnostic-logging.md)).
