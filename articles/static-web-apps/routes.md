...
ms.locfileid: "101739650"
---
# <a name="routes-in-azure-static-web-apps-preview"></a>Маршруты в предварительной версии Статических веб-приложений Azure

> [!IMPORTANT]
> Функциональные возможности, определенные в *routes.js* файле, теперь являются устаревшими и лучше реализованы в [файле конфигурации](./configuration.md#routes)статических веб-приложений Azure.
