...
Каждое правило состоит из шаблона маршрута, а также одного или нескольких необязательных свойств правила. Примеры определения см. в [примере файла конфигурации](#example-configuration-file).
