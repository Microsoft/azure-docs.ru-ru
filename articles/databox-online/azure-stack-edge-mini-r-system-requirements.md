...
Следующие пограничные учетные записи хранения поддерживаются с интерфейсом интерфейса RESTFUL устройства. На устройстве создаются учетные записи хранения пограничных устройств. Дополнительные сведения см. в статье [пограничные учетные записи хранения](azure-stack-edge-gpu-manage-storage-accounts.md#about-edge-storage-accounts) .
...
|Тип  |Учетная запись хранения  |Комментарии  |
|---------|---------|---------|
|Стандартный     |GPv1: блочный большой двоичный объект, страничный BLOB-объект         | Тип номера SKU — Standard_LRS        |
