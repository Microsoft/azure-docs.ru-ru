...
2. Выберите элемент **Add Wi-Fi profile** (Добавить профиль Wi-Fi) и отправьте нужный профиль Wi-Fi. 
    ...
    Сведения о подготовке профилей Wi-Fi см. в статье [Использование профилей Wi-Fi с Azure Stack пограничных устройств R](azure-stack-edge-mini-r-use-wifi-profiles.md).
