...
- **Частично подключено** — в этом режиме устройство не может отправлять или скачивать данные общего доступа, но управлять ими можно с помощью портал Azure.
