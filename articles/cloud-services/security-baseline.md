...
- [Список служб, поддерживаемых политикой Azure](/cli/azure/azure-services-the-azure-cli-can-manage)
...
- [Дополнительные сведения о настройке журналов потоков см. в статье](/cli/azure/azure-services-the-azure-cli-can-manage)
...
- [Настройка диагностики для облачной службы Azure (классическая модель) и виртуальных машин](/visualstudio/azure/vs-azure-tools-diagnostics-for-cloud-services-and-virtual-machines)
...
Для получения дополнительной справки API классической модели развертывания предоставляет программный доступ к классической функции модели развертывания, доступной в портал Azure. Пакет Azure SDK для Python можно использовать для управления облачными службами Azure и учетными записями хранения Azure. Пакет Azure SDK для Python служит оболочкой для API классической модели развертывания — REST API. Все операции API выполняются через TLS и проходят взаимную проверку подлинности с помощью сертификатов X. 509 v3. Доступ к службе управления можно получить из службы, работающей в Azure, или непосредственно через Интернет из любого приложения, которое может отправить HTTPS-запрос и получить HTTPS-ответ.

- [Настройка TLS для приложения в Azure](cloud-services-configure-ssl-certificate-portal.md)

- [Использование классической модели развертывания из Python](cloud-services-python-how-to-use-service-management.md)
...
**Руководство**. Вы можете использовать классические оповещения метрики в Azure Monitor, чтобы получать уведомления при применении одной из метрик к критическим ресурсам. Классические оповещения метрик — это устаревшие функции, позволяющие создавать предупреждения только для неизмерений-метрик. Существуют более новые функциональные возможности, называемые оповещениями метрик, которые имеют улучшенную функциональность по сравнению с классическими оповещениями метрик. 
