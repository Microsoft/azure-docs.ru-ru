...
Выберите соединитель данных центра безопасности для потоковой передачи оповещений в Azure Sentinel в соответствии с потребностями и бизнес-требованиями Организации.
