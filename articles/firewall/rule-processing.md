...
Входящее подключение к Интернету можно включить, настроив преобразование сетевых адресов назначения (ДНАТ), как описано в разделе [руководство. Фильтрация входящего трафика с помощью ДНаТ брандмауэра Azure с использованием портал Azure](tutorial-firewall-dnat.md). Правила NAT применяются по приоритету перед правилами сети. Если совпадение найдено, добавляется неявно соответствующее правило сети, чтобы разрешить преобразованный трафик. По соображениям безопасности рекомендуемый подход заключается в добавлении определенного источника Интернета, чтобы разрешить ДНаТ доступ к сети и избежать использования подстановочных знаков.
