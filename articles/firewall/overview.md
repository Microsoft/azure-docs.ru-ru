...
## <a name="azure-firewall-premium-preview"></a>Брандмауэр Azure уровня "Премиум" (предварительная версия)

Брандмауэр Azure уровня "Премиум" (предварительная версия) — это брандмауэр следующего поколения с возможностями, требуемыми для работы в строго конфиденциальных и регулируемых средах. Эти возможности включают проверку TLS, IDPS, фильтрацию URL-адресов и веб-категории.

Дополнительные сведения о брандмауэре см. в статье [Функции Брандмауэра Azure уровня "Премиум" (предварительная версия)](premium-features.md).


Дополнительные сведения о настройке брандмауэра на портале Azure см. в статье [Брандмауэр Azure уровня "Премиум" (предварительная версия) на портале Azure](premium-portal.md).
...
|---------|---------|---------|
|Если в правиле вы изменяете IP-адрес на группу IP-адресов (или наоборот) с помощью портала, оба типа сохраняются, но на портале отображается только один.|Эта проблема возникает при использовании классических правил.<br><br>При использовании портала для обновления типа источника правила NAT с IP-адреса на группу IP-адресов (или наоборот), он сохраняет оба типа в серверной части, но предоставляет только обновленный тип.<br><br>Такая же ситуация возникает при обновлении типа назначения правила сети или приложения с типа IP-адреса на тип группы IP (или наоборот).|Исправление для портала планируется выпустить в марте 2021 г.<br><br>Пока же используйте Azure PowerShell, Azure CLI или API для изменения IP-адреса на группу IP-адресов (или наоборот).|
...
- [Краткое руководство. Создание Брандмауэра Azure и политики брандмауэра — шаблон ARM](../firewall-manager/quick-firewall-policy.md)
- [Краткое руководство. Развертывание Брандмауэра Azure с зонами доступности с помощью шаблона ARM](deploy-template.md)
