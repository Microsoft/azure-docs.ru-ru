...
1. В качестве **имени группы ресурсов** введите *Test-FW-RG*.
1. В качестве **расположения группы ресурсов** выберите расположение. Все остальные ресурсы, которые вы будете создавать, должны находиться в том же расположении.
...
1. В поле **Диапазон IPv4-адресов** введите **10.0.0.0/16**.
1. В разделе **Подсеть** выберите **по умолчанию**.
...
1. На **домашней странице** или в меню портала Azure выберите **Создать ресурс**.
2. Выберите **Windows Server 2016 Datacenter**.
...
7. В поле **Регион** выберите использованное ранее расположение.
...
1. Выберите **Виртуальная сеть** > **Test-FW-VN**.
1. В качестве **подсети** выберите **Workload-SN**. Убедитесь, что для этого маршрута выбрана только подсеть **Workload-SN**. В противном случае брандмауэр не будет работать правильно.
