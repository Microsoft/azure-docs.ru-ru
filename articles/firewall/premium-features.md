...
|---------|---------|---------|
|Проверка TLS поддерживается только для стандартного порта HTTPS|Проверка TLS поддерживает только протоколы HTTPS/443. |Нет. Другие порты будут поддерживаться в общедоступной версии.|
