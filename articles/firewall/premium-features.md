...
Предварительная версия Azure Firewall Premium поддерживается в следующих регионах:

- Западная Европа (Открытая/Европа)
- Восточная часть США (открытая/США)
- Восточная Австралия (открытая/Австралия)
- Юго-Восточная Азия (открытая/Азиатско-Тихоокеанский регион)
- Южная часть Соединенного Королевства (открытый/Великобритания)
- Северная Европа (Открытая/Европа)
- Восточная часть США 2 (открытая/США)
- Юго-Центральная часть США (открытая/США)
- Западная часть США 2 (открытая/США)
- Западная часть США (открытая/США)
- Центральная американская (открытая/США)
- Северо-центральная часть США (открытая/США)
- Восточная Япония (открытая/Япония)
- Восточная Азия (Public/Азиатско-Тихоокеанский регион)
- Центральная Канада (общедоступная или Канада)
- Центральная Франция (открытая/Франция)
- Северный Африка (открытый/Южная Африка)
- Северная ОАЭ (общедоступная или ОАЭ)
- Северная Швейцария (общедоступная/Швейцария)
- Южная Бразилия (общедоступный/Бразилия)
- Норвегия восток (открытый/Норвегия)
- Центральная Австралия (открытая/Австралия)
- Центральная Австралия 2 (открытая/Австралия)
- Юго-Восточная Австралия (открытая/Австралия)
- Восточная Канада (открытый/Канада)
- Центральная американская (EUAP) (общедоступная/ранний (США))
- Южная Франция (открытая/Франция)
- Западная Япония (открытая/Япония)
- Южная Корея (открытая/Корея)
- Центральная часть ОАЭ (публичная или ОАЭ)
- Западная часть Соединенного Королевства (открытый/Великобритания)
- Западная Центральная часть США (открытая/США)
- Западная Индия (открытая/Индия)
...
|Сертификаты клиента (TLS)|Клиентские сертификаты используются для создания взаимного отношения доверия между клиентом и сервером. Сертификаты клиента используются во время согласования TLS. Брандмауэр Azure повторно согласовывает соединение с сервером и не имеет доступа к закрытому ключу сертификатов клиентов.|Нет|
