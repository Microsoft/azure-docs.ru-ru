...
Подробное и исчерпывающее руководством по миграции см. в статье о [миграции с MySQL на Azure](https://github.com/Azure/azure-mysql/tree/master/MigrationGuide). 
