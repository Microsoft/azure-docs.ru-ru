...
> [!IMPORTANT]
> При сбросе пароля администратора сервера его права автоматически сбрасываются к значениям по умолчанию. Рассмотрите возможность сброса пароля администратора сервера, если вы случайно отменили один или несколько прав администратора сервера.
