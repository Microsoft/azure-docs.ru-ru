...
- **База данных Azure для MySQL**. Этот вариант является полностью управляемым ядром СУБД MySQL на основе стабильной версии выпуска MySQL Community Edition. Эта реляционная база данных как услуга (DBaaS), размещенная на облачной платформе Azure, попадает в категорию PaaS в отрасли.
  ...
  Гибкие серверы лучше всего подходят в следующих ситуациях:
...
|:-------------------|:-------------------------------------------|:---------------------------------------------|:---------------------------------------|
| Поддержка версии MySQL | 5,6, 5,7 & 8,0| 5,7 & 8,0 | Любая версия|
...
| Дополнительное масштабирование операций ввода-вывода | Не поддерживается| Поддерживается| Не поддерживается|
...
| Размещение зоны | Не поддерживается | Поддерживается | Поддерживается|
