...
1. Если вы хотите, чтобы срок действия условий политики использования истек по расписанию, задайте для параметра **срок действия** значение **включено**. Когда этот параметр включен, отображаются два дополнительных параметра расписания.
    ...
    ![Параметр срока действия Expire consents позволяет задать дату начала, частоту и длительность](./media/terms-of-use/expire-consents.png)
...
1. В разделе **Условный доступ** используйте **шаблон принудительное использование с политикой условного доступа** , чтобы выбрать шаблон для применения условий политики использования.
   ...
   >Элементы управления политики условного доступа (включая условия применения политик) не поддерживают принудительное применение для учетных записей служб. Рекомендуется исключить все учетные записи служб из политики условного доступа.
    ...
    Настраиваемые политики условного доступа позволяют применять подробные условия применения политик к конкретному облачному приложению или группе пользователей. Дополнительную информацию см. в разделе [Быстрый старт: требование принятия условий использования перед доступом к облачным приложениям](require-tou.md)
...
1. Для политики условий использования щелкните числа в разделе **принято** или **отклонено** , чтобы просмотреть текущее состояние пользователей.
    ...
    ![Панель со списком пользователей, принявших условия использования](./media/terms-of-use/accepted-tou.png)
...
1. Чтобы просмотреть журнал для отдельного пользователя, щелкните многоточие (**…**) и выберите **Просмотреть журнал**.
   ...
   ![Область просмотра журнала содержит сведения о приеме, отклонении и истечении срока действия пользователя.](./media/terms-of-use/view-history-pane.png)
...
![Примеры условий использования, отображаемые при входе пользователя](./media/terms-of-use/user-tou.png)
...
![Примеры условий использования, отображаемые при входе пользователя с мобильного устройства](./media/terms-of-use/mobile-tou.png)
...
### <a name="how-users-can-review-their-terms-of-use"></a>Каким образом пользователи могут просмотреть свои условия использования
...
1. На панели изменение условий использования можно изменить следующее:
    - **Название (Name)**  — это внутреннее название условий использования, которое не сообщается конечным пользователям.
    - **Отображаемое название** — это название, которое конечные пользователи могут видеть при просмотре условий использования
...
8.  Теперь вы увидите самую последнюю версию в столбце Document.
