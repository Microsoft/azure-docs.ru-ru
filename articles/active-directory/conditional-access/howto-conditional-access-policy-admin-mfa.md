...
1. В разделе **Назначения** выберите **Пользователи и группы**.
   1. В разделе **включить** выберите **роли каталога** и выберите встроенные роли, например:
      ...
      * Администратор пользователей
      ...
      > [!WARNING]
      > Политики условного доступа поддерживают встроенные роли. Политики условного доступа не применяются к другим типам ролей, включая [административные роли с областью действия](../roles/admin-units-assign-roles.md) или [пользовательскую](../roles/custom-create.md)роль.
