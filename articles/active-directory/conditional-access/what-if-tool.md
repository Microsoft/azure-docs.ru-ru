...
:::image type="content" source="./media/what-if-tool/02.png" alt-text="Снимок экрана страницы портал Azure What If с полями для пользователя, облачными приложениями, адресом P, платформой устройства, клиентским приложением и риском для входа." border="false":::
...
:::image type="content" source="./media/what-if-tool/03.png" alt-text="Снимок экрана отчета об оценке. Текст указывает, что по крайней мере одна классическая политика настроена. Доступны вкладки для просмотра политик." border="false":::
