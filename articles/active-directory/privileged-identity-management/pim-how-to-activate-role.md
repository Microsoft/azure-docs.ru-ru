...
Если вам необходимо получить роль Azure AD, вы можете запросить активацию, открыв **Мои роли** в Управлении привилегированными пользователями.
...
При активации роли в управление привилегированными пользователями ваша Активация может быть отложена на порталах администрирования, отличных от портал Azure, например на портале Office 365. Если активация отложена, выйдите из портала, который вы используете, и снова выполните вход. Затем используйте управление привилегированными пользователями, чтобы убедиться, что вы указаны как член роли.
