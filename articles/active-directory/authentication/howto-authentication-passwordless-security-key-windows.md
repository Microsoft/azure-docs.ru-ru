...
description: Узнайте, как включить вход с использованием ключа безопасности без пароля для Azure Active Directory с помощью ключей безопасности FIDO2.
...
ms.locfileid: "101653513"
---
# <a name="enable-passwordless-security-key-sign-in-to-windows-10-devices-with-azure-active-directory"></a>Включение входа с помощью ключа безопасности без пароля для устройств Windows 10 с Azure Active Directory 
...
| [Объединенная регистрация сведений о безопасности](concept-registration-mfa-sspr-combined.md) | X | X |
...
Устройства, присоединенные к Azure AD, должны работать под управлением Windows 10 версии 1909 или более поздней.
