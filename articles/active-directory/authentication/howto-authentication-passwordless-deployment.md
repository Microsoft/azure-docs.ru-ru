...
-    Гибридные Azure Active Directory присоединенные к устройствам Windows 10
...
Чтобы разрешить доступ к локальным ресурсам, выполните действия по [включению ключа безопасности без пароля для входа в локальные ресурсы](howto-authentication-passwordless-security-key-on-premises.md).
