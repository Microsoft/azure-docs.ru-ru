---
title: Azure Active Directory вход без пароля
...
| Поставщик | Contact |
| --- | --- |
| юбико | [https://www.yubico.com/solutions/passwordless/](https://www.yubico.com/solutions/passwordless/) |
...
- Конечные пользователи могут выполнять вход с использованием следующих методов проверки подлинности без пароля:
   - Microsoft Authenticator приложение. работает в сценариях, где используется проверка подлинности Azure AD, включая все браузеры, во время установки Windows 10 и интегрированные мобильные приложения в любой операционной системе.
