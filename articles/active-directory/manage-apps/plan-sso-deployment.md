...
#### <a name="sso-issues-for-applications"></a>Проблемы единого входа для приложений

- [Проблема с ВХОДом пароля для приложений](./troubleshoot-password-based-sso.md) 

- [Проблемы при входе в приложения, настроенные для единого входа на основе SAML](/troubleshoot/azure/active-directory/troubleshoot-sign-in-saml-based-apps)   
