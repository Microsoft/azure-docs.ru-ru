...
Прежде чем пользователь сможет войти в приложение, и приложение сможет получить доступ к данным Организации, пользователь или администратор должен предоставить разрешения приложения. Можно указать, разрешено ли согласие пользователя, и при каких условиях. **Корпорация Майкрософт рекомендует разрешить согласие пользователя только для приложений от проверенных издателей.**

Дополнительные сведения см. [в статье Настройка согласия конечных пользователей для приложений](../manage-apps/configure-user-consent.md) .

### <a name="group-owner-consent-for-apps-accessing-data"></a>Согласие владельца группы для приложений, обращающихся к данным

Владельцы групп и групп могут авторизовать приложения, такие как приложения, опубликованные сторонними поставщиками, для доступа к данным Организации, связанным с группой. Дополнительные сведения см. [в разделе согласие на использование ресурсов в Microsoft Teams](https://docs.microsoft.com/microsoftteams/resource-specific-consent) . 

Вы можете указать, следует ли разрешить или запретить эту функцию.
...
* [Configuration Manager для Internet Explorer](/mem/configmgr/core/clients/deploy/deploy-clients-to-windows-computers)
...
| Например, .| Управление рисками.| Повышение производительности| Система управления и соответствие требованиям |
| - | - | - | -|
