...
Когда ИТ-администраторов спрашивают, сколько облачных приложений, по их мнению, используется сотрудниками организации, они называют в среднем цифру в районе 30 или 40. В реальности же этих приложений больше 1000. Теневые ИТ помогают узнать, какие приложения сейчас используются и какой у них уровень риска. 80 % сотрудников используют несанкционированные приложения, которые не подвергались проверке и, возможно, не соответствуют политикам безопасности и соответствия требованиям. Кроме того, сотрудники могут получать доступ к вашим ресурсам и приложениям извне корпоративной сети, поэтому правил и политик брандмауэра становится недостаточно.
...
- Контроль санкционированных приложений
