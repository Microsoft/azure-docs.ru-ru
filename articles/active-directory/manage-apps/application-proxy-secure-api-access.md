...
Последним шагом является настройка собственного приложения. Следующий фрагмент кода из файла *Form1. CS* в примере приложения NativeClient заставляет библиотеку MSAL получить маркер для запроса вызова API и присоединить его как носитель к заголовку приложения.
