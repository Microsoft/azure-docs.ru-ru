...
Вы также можете публиковать приложения с помощью [PowerShell](/powershell/module/azuread/?view=azureadps-2.0-preview&preserve-view=true).
