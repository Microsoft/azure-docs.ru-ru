...
ms.locfileid: "104589469"
---
# <a name="use-the-ad-fs-application-activity-report-to-migrate-applications-to-azure-ad"></a>Использование отчета о действиях приложения AD FS для миграции приложений в Azure AD
...
3. В разделе **действие** выберите **Использование & Insights**, а затем выберите **AD FS действие приложения** , чтобы открыть список всех AD FS приложений в вашей организации.
