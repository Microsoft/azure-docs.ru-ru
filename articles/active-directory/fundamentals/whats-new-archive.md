...
Дополнительные сведения см. в статье [Сведения об использовании и аналитика методов проверки подлинности (предварительная версия)](../authentication/howto-authentication-methods-activity.md).
