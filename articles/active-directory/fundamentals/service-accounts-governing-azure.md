...
| Название| Стандартизированное имя учетной записи| Создайте схему именования для всех учетных записей служб, чтобы можно было легко выполнять поиск, сортировку и фильтрацию учетных записей служб. |
...
1. После отмены подготовки связанного приложения или скрипта с помощью учетной записи службы [Отслеживайте входы](https://docs.microsoft.com/azure/active-directory/reports-monitoring/concept-sign-ins#sign-ins-report) и доступ к ресурсам.
