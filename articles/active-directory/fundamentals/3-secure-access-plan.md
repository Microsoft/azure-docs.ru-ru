...
* **Группы Microsoft 365**. Задайте [политику срока действия группы](/microsoft-365/solutions/microsoft-365-groups-expiration-policy) для групп Microsoft 365, к которым приглашены внешние пользователи. 
...
| Управление правами| **Добавление пользователя с помощью назначения или самостоятельный доступ**| | Проверки доступа|**Истечение срока действия или удаление из пакета, доступ к пакету**|
...
| - |-|-|-|-|
| Управление правами| **Добавление пользователя с помощью назначения или самостоятельный доступ**| **Пакеты для доступа**| **Пакеты для доступа**|  |
