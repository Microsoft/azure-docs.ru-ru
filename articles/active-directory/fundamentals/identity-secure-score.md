...
Показатель безопасности идентификации — это процентная доля, которая выступает в качестве индикатора того, как она соответствует рекомендациям корпорации Майкрософт по обеспечению безопасности. Каждое действие улучшения в оценке безопасности идентификации адаптировано к конкретной конфигурации.  
