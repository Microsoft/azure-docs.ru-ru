...
1. **Полностью изолируйте учетные записи администратора Microsoft 365.** Они должны быть:
    ...
    * В Azure AD.
    ...
    Дополнительные сведения см. в [обзоре ролей администратора Microsoft 365](/microsoft-365/admin/add-users/about-admin-roles). См. также [роли для Microsoft 365 в Azure AD](../roles/m365-workload-docs.md).
...
* **Совместная** работа. используйте группы Microsoft 365 и Microsoft Teams для современной совместной работы. Списание локальных списков рассылки и [Обновление списков рассылки до Microsoft 365 групп в Outlook](/office365/admin/manage/upgrade-distribution-lists).
