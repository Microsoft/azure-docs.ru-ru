...
Эти запросы можно отфильтровать. Дополнительные сведения см. в документации Graph по [Get servicePrincipal](/graph/api/serviceprincipal-get).
