...
> | [Администратор гибридных удостоверений](#hybrid-identity-administrator) | Может управлять AD для подготовки облака Azure AD, Azure AD Connect и параметров Федерации. | 8ac3fc64-6eca-42ea-9e69-59f4c7b60eb2 |
