...
Задача | Наименее привилегированная роль | Дополнительные роли
---- | --------------------- | ----------------
Добавить ресурсы в каталог | Администратор пользователей | С помощью управления назначением можно делегировать эту задачу владельцу каталога (см.[документацию](../governance/entitlement-management-catalog-create.md#add-additional-catalog-owners)).
