---
title: Что такое подготовка приложения с помощью Azure Active Directory? | Документы Майкрософт
description: В этой статье приведены рекомендации по подготовке приложений.
...
ms.locfileid: "93135014"
---
# <a name="what-is-app-provisioning"></a>Что такое подготовка приложений?
