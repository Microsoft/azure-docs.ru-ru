...
## <a name="disable-and-delete-external-identities-with-azure-ad-access-reviews"></a>Отключение и удаление внешних удостоверений с помощью проверок доступа Azure AD
