...
- Если вы хотите использовать портал Azure для управления доступом к ресурсам, см. статью [Руководство. Управление доступом к ресурсам — портал Azure](entitlement-management-access-package-first.md).
