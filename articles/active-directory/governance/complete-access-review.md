...
1. В списке щелкните проверку доступа.
    ...
    При просмотре проверки доступа, которая проверяет гостевой доступ между группами Microsoft 365, в колонке "Обзор" перечислены все группы в обзоре. 
