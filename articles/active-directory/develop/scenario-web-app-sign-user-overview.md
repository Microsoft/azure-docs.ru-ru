...
Если вы являетесь Node.js разработчиком, попробуйте выполнить следующие действия в кратком руководстве:

[Краткое руководство. Добавление входа с помощью Microsoft в веб-приложение Node.js](quickstart-v2-nodejs-webapp-msal.md)
...
Перейдите к следующей статье в этом сценарии — [Регистрация приложения](./scenario-web-app-sign-user-app-registration.md?tabs=nodejs).
