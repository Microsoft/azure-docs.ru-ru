...
> [!IMPORTANT]
> По умолчанию новые регистрации приложений скрыты для пользователей. Когда вы будете готовы предоставить пользователям доступ к приложению на своей [странице "Мои приложения"](../user-help/my-apps-portal-end-user-access.md), можно включить его отображение. Чтобы включить отображение приложения, на портале Azure перейдите к разделу **Azure Active Directory** > **Корпоративные приложения** и выберите приложение. Затем на странице **Свойства** переключите параметр **Видно пользователям?** на значение "Да".
