...
Это командлеты в [модуле предварительной версии Azure Active Directory PowerShell для Graph](/powershell/module/azuread/?view=azureadps-2.0-preview&preserve-view=true#service-principals).
