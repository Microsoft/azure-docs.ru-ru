...
description: Узнайте, как включить режим общего устройства, чтобы разрешить оказался работникам совместно использовать устройство Android.
...
Попробуйте [использовать режим общего устройства в приложении Android](tutorial-v2-shared-device-mode.md) , в котором показано, как запустить оказался рабочее приложение на устройстве Android с общим режимом.
