...
:::image type="content" source="./media/concept-identity-protection-security-overview/02.png" alt-text="Снимок экрана портал Azure Обзор безопасности с плитками, видимыми для пользователей с высоким риском и средним риском, а также с другими факторами риска." border="false":::
