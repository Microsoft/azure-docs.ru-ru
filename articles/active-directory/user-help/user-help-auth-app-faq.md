...
Ответ **. Да**, автозаполнение [личных учетных записей Майкрософт](https://go.microsoft.com/fwlink/?linkid=2144423) теперь работает для большинства корпоративных пользователей, даже если Рабочая или учебная учетная запись добавляется в приложение проверки подлинности. Вы можете заполнить форму, чтобы разрешить или запретить Автозаполнение вашей организации и [отправить ее группе проверки подлинности](https://aka.ms/ConfigureAutofillInAuthenticator). Автозаполнение сейчас недоступно для рабочих или учебных учетных записей.
