...
> [!Note]
> Если параметр **Рабочий телефон** недоступен для выбора, возможно, ваша организация не позволяет использовать номер рабочего телефона для проверки. Если это так, вам нужно выбрать другой метод или обратиться за помощью к администратору. 
> 
> Объединенные пользователи регистрации не увидят возможности использовать расширение с параметром **Рабочий телефон**.
