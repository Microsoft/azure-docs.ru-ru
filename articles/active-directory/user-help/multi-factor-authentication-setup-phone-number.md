...
1. На странице **Дополнительная проверка безопасности** выберите **Телефон проверки подлинности** в разделе **Шаг 1. как связаться с вами** , выберите страну или регион из раскрывающегося списка, а затем введите номер телефона мобильного устройства.
...
3. Введите код проверки из текстового сообщения, отправленного из корпорации Майкрософт, в раздел **Шаг 2. Мы отправили текстовое сообщение в телефонную** область, а затем щелкните **проверить**.
...
4. В разделе **Шаг 3. сохранить использование существующих приложений** скопируйте предоставленный пароль приложения и вставьте его в безопасном месте.
