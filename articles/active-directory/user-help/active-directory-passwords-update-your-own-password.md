...
Если вы знаете свой пароль и хотите его изменить, см. Разделы [Действия по изменению пароля](#how-to-change-your-password) этой статьи.
...
После сброса пароля вы можете получить электронное письмо с подтверждением от учетной записи типа «Microsoft от имени \<*your_organization*>». Если вы получили такое сообщение по электронной почте, но перед этим не выполняли сброс пароля, немедленно обратитесь к администратору своей организации.
...
### <a name="to-change-your-password-from-the-my-apps-portal"></a>Чтобы изменить пароль на портале Мои приложения
