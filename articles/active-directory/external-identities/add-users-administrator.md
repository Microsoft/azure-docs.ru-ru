...
7. Если пользователь еще не принял приглашение, в разделе **удостоверение** для параметра **приглашение принимает** значение **нет**. Чтобы повторно отправить приглашение, выберите **(управление)**. Затем на странице " **Управление приглашениями** " рядом с пунктом "* * повторно отправить приглашение?" Выберите **Да**, а затем — **Готово**.
...
> Кроме того, только пользователи с приглашенными разрешениями смогут повторно отправить приглашения.
