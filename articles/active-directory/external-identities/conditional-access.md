...
| 2. | Клиент ресурсов идентифицирует пользователя в качестве внешнего пользователя с одноразовым [секретным кодом (OTP)](./one-time-passcode.md) и отправляет пользователю сообщение электронной почты с OTP.|
...
[Политика на основе расположения](../conditional-access/concept-conditional-access-conditions.md#locations) , основанная на ДИАПАЗОНАХ IP-адресов, может быть применена, если в приглашенной Организации можно создать диапазон доверенных IP-адресов, определяющий Организации партнеров.
...
- [Защита идентификации и пользователи B2B](../identity-protection/concept-identity-protection-b2b.md)
