...
- [Сброс состояния активации для гостевого пользователя](reset-redemption-status.md)
...
- [Azure Active Directory внешние удостоверения: новые возможности](whats-new-docs.md)
- [Разрешение или запрет приглашений для пользователей B2B из определенных организаций](allow-deny-list.md)
- [API службы совместной работы Azure Active Directory B2B и настройка](customize-invitation-api.md)
- [Пригласите внутренних пользователей в службу совместной работы B2B](invite-internal-users.md)
- [Microsoft 365 внешний общий доступ и Azure Active Directory (Azure AD) B2B для совместной работы](o365-external-user.md)
- [Прямая федерация с AD FS и сторонними поставщиками для гостевых пользователей (предварительная версия)](direct-federation.md)
