...
7. В разделе **включить гостевую службу регистрация через потоки пользователей** выберите **Да** , если вы хотите иметь возможность создавать потоки пользователей, позволяющие пользователям регистрироваться в приложениях. Дополнительные сведения об этом параметре см. [в разделе Добавление пользователя для самостоятельной регистрации в приложении](self-service-sign-up-user-flow.md).
...
7. В разделе **ограничения совместной работы** можно указать, следует ли разрешить или запретить заданным доменам приглашения и ввести в текстовые поля определенные имена доменов. Если нужно заблокировать несколько доменов, вводите каждый из них в новой строке. Дополнительные сведения см. в статье [Предоставление или отзыв приглашений пользователям B2B из отдельных организаций](allow-deny-list.md).
