...
* Гостевые пользователи в клиенте Azure AD, помеченные как "гость" (UserType = = Guest), не могут зарегистрироваться для SSPR с помощью [https://aka.ms/ssprsetup](https://aka.ms/ssprsetup) . Этот тип гостевых пользователей может выполнять SSPR только через [https://aka.ms/sspr](https://aka.ms/sspr) . 
