...
* RingCentral поддерживает единый вход, инициируемый **поставщиком удостоверений**.

## <a name="add-ringcentral-from-the-gallery"></a>Добавление RingCentral из коллекции
...
## <a name="configure-and-test-azure-ad-sso-for-ringcentral"></a>Настройка и проверка единого входа Azure AD для RingCentral
...
Чтобы настроить и проверить единый вход Azure AD в RingCentral, выполните следующие действия:
...
1. На портале Azure на странице интеграции с приложением **RingCentral** найдите раздел **Управление** и выберите **Единый вход**.
...
1. Если у вас нет **файла метаданных поставщика услуг**, введите значения в следующие поля.
    ...
    а. В текстовом поле **Идентификатор** введите один из URL-адресов:
    ...
    b. В текстовом поле **URL-адрес ответа** введите один из URL-адресов:
...
В этом разделе описано, как включить единый вход в Azure для пользователя B.Simon, предоставив этому пользователю доступ к RingCentral.
...
1. Щелкните **Tools** (Средства) вверху.
    ...
    ![Снимок экрана: элемент Tools (Средства), выбранный на сайте компании RingCentral.](./media/ringcentral-tutorial/ringcentral-1.png)

1. Перейдите к параметру **Single Sign-on** (Единый вход).

    ![Снимок экрана: параметр Single Sign-on (Единый вход), выбранный в меню Tools (Средства).](./media/ringcentral-tutorial/ringcentral-2.png)
...
1. На странице **Single Sign-on** (Единый вход) в разделе **SSO Configuration** (Настройка единого входа) в **шаге 1** щелкните **Edit** (Изменить) и выполните следующие шаги:
    ...
    ![Снимок экрана: страница SSO Configuration (Настройка единого входа), где вы можете выбрать параметр Edit (Изменить).](./media/ringcentral-tutorial/ringcentral-3.png)

1. На странице **Set up Single Sign-on** (Настройка единого входа) выполните следующие действия:

    ![Снимок экрана: страница SSO Configuration (Настройка единого входа), на которой можно отправить метаданные IDP.](./media/ringcentral-tutorial/ringcentral-4.png)
    ...
    ![Снимок экрана: страница SSO Configuration (Настройка единого входа), где вы можете выбрать элемент Download (Скачать).](./media/ringcentral-tutorial/ringcentral-6.png) 

    е) На этой же странице перейдите к разделу **Enable SSO** (Включение единого входа) и выполните следующие действия:

    ![Снимок экрана: раздел Enable SSO (Включение единого входа), в котором можно завершить настройку.](./media/ringcentral-tutorial/ringcentral-5.png)
