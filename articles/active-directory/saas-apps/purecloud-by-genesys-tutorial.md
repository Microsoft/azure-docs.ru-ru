...
## <a name="add-purecloud-by-genesys-from-the-gallery"></a>Добавление PureCloud от Genesys из коллекции
...
## <a name="configure-and-test-azure-ad-sso-for-purecloud-by-genesys"></a>Настройка и проверка единого входа Azure AD для PureCloud от Genesys
...
Чтобы настроить и проверить единый вход Azure AD в PureCloud от Genesys, выполните действия из следующих стандартных блоков:
...
1. На портале Azure на странице интеграции с приложением **PureCloud от Genesys** найдите раздел **Управление** и выберите **Единый вход**.
...
1. Если вы хотите настроить приложение в режиме, инициируемом **поставщиком удостоверений**, в разделе **Базовая конфигурация SAML** введите значения для следующих полей:
    ...
    а. В поле **Идентификатор** введите URL-адреса, которые соответствуют вашему региону:
    ...
    b. В поле **URL-адрес ответа** введите URL-адреса, которые соответствуют вашему региону:
...
1. Чтобы настроить приложение для работы в режиме, инициируемом **поставщиком услуг**, выберите **Задать дополнительные URL-адреса** и выполните следующие действия.
    ...
    В поле **URL-адрес для входа** введите URL-адреса, которые соответствуют вашему региону:
...
1. Выберите **Администратор** вверху и перейдите к пункту **Единый вход** в разделе **Интеграции**.
    ...
    ![Снимок экрана: окно PureCloud Admin (Администратор PureCloud), где можно выбрать Single Sign-on (Единый вход).](./media/purecloud-by-genesys-tutorial/configure-1.png)

1. Перейдите на вкладку **ADFS/Azure AD (Premium)** и выполните приведенные ниже действия.

    ![Снимок экрана: страница Integrations (Интеграции), где можно ввести описанные значения.](./media/purecloud-by-genesys-tutorial/configure-2.png)
    ...
    ![Снимок экрана: область Properties (Свойства), где можно найти значение идентификатора приложения.](./media/purecloud-by-genesys-tutorial/configure-6.png)
...
1. Нажмите **Администратор** вверху и перейдите к пункту **Пользователи** в разделе **Пользователи и разрешения**.
    ...
    ![Снимок экрана: окно PureCloud Admin (Администратор PureCloud), где можно выбрать People (Пользователи).](./media/purecloud-by-genesys-tutorial/configure-3.png)

1. На странице **Пользователи** щелкните **Добавить пользователя**.

    ![Снимок экрана: страница People (Пользователи), где можно добавить пользователя.](./media/purecloud-by-genesys-tutorial/configure-4.png)

1. В диалоговом окне **Добавить пользователей в организацию** выполните приведенные ниже действия.

    ![Снимок экрана: страница для ввода описанных значений](./media/purecloud-by-genesys-tutorial/configure-5.png)
...
* Выберите **Тестировать приложение** на портале Azure. Вы будете перенаправлены по URL-адресу для входа в PureCloud от Genesys, где можно инициировать поток входа.  

* Перейдите по URL-адресу для входа в PureCloud от Genesys и инициируйте поток входа.

#### <a name="idp-initiated"></a>Вход, инициированный поставщиком удостоверений

* На портале Azure выберите **Тестировать приложение**, и вы автоматически войдете в приложение PureCloud от Genesys, для которого настроен единый вход. 

Вы можете также использовать портал "Мои приложения" корпорации Майкрософт для тестирования приложения в любом режиме. Щелкнув плитку PureCloud от Genesys на портале "Мои приложения", вы попадете на страницу входа приложения для инициации потока входа (при настройке в режиме поставщика службы) или автоматически войдете в приложение PureCloud от Genesys, для которого настроен единый вход (при настройке в режиме поставщика удостоверений). Дополнительные сведения о портале "Мои приложения" см. в [этой статье](../user-help/my-apps-portal-end-user-access.md).

## <a name="next-steps"></a>Дальнейшие действия

После настройки PureCloud от Genesys вы можете применить функцию управления сеансом, которая защищает конфиденциальные данные вашей организации от хищения и несанкционированного доступа в реальном времени. Управление сеансом является расширением функции условного доступа. [Узнайте, как применять управление сеансами с помощью Microsoft Cloud App Security](/cloud-app-security/proxy-deployment-any-app).