...
1. Войдите на сайт **Gigya** для компании в качестве администратора.
...
3. В диалоговом окне "Пригласить пользователей" выполните следующие действия.
    ...
    a. В текстовом поле **Адрес электронной почты** введите адрес электронной почты действительной учетной записи Azure Active Directory, которую необходимо подготовить.
