---
title: Руководство. Интеграция Azure Active Directory с пакетом интеграции webMethods | Документация Майкрософт
...
---
# <a name="tutorial-azure-active-directory-integration-with-webmethods-integration-suite"></a>Руководство. Интеграция Azure Active Directory с пакетом интеграции WebMethods
