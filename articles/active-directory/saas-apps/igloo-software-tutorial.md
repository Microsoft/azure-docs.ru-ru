...
3. На вкладке **Членство** нажмите **Параметры входа**.

    ![Параметры входа](./media/igloo-software-tutorial/ic783968.png "Параметры входа")

4. В разделе "Параметры SAML" нажмите **Настройка проверки подлинности SAML**.

    ![Настройка SAML](./media/igloo-software-tutorial/ic783969.png "Настройка SAML")

5. В разделе **Общие параметры** выполните следующие шаги.

    ![Общая конфигурация](./media/igloo-software-tutorial/ic783970.png "Общая конфигурация")

    a. В текстовом поле **Имя соединения** введите выбранное имя для конфигурации.
...
6. В разделе **Конфигурация ответа и проверки подлинности** выполните следующие шаги.
    ...
    a. В качестве **Поставщика удостоверений** выберите **Microsoft ADFS**.

    b. В качестве **Типа удостоверения** выберите **Адрес электронной почты**. 

    c. В текстовом поле **Атрибут адреса электронной почты** введите **emailaddress**.

    d. В текстовом поле **Атрибут имени** введите **givenname**.

    д) В текстовом поле **Атрибут фамилии** введите **surname**.
...
7. Выполните следующие действия для завершения настройки:
    ...
    a. В качестве **Создание пользователя при входе** выберите **Создавать нового пользователя на сайте при его входе**.

    b. В качестве значения **Параметры входа** выберите **Использовать кнопку SAML на экране "Вход"**.
