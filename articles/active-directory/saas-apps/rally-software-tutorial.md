...
2. В верхней части панели инструментов нажмите **Настройка** и выберите **Подписка**.
...
3. Введите имя в текстовом поле "Новый пользователь", а затем нажмите кнопку **Добавить с подробностями**.
