...
2. В верхней части панели инструментов щелкните **Инструменты администрирования**, а затем нажмите кнопку **Консоль управления**.
   
    ![Консоль управления](./media/picturepark-tutorial/ic795062.png "Консоль управления")

3. Щелкните **Проверка подлинности** и выберите пункт **Поставщики удостоверений**.
   
    ![Аутентификация](./media/picturepark-tutorial/ic795063.png "Аутентификация")

4. В разделе **Настройка поставщика удостоверений** выполните следующие действия.
    ...
    c. Выберите **Задать по умолчанию**.
...
1. В верхней части панели инструментов щелкните **Инструменты администрирования**, а затем нажмите кнопку **Пользователи**.
   
    ![Пользователи](./media/picturepark-tutorial/ic795067.png "Пользователи")

1. На вкладке **Обзор пользователей** щелкните **Создать**.
...
1. В диалоговом окне **Create User** (Создание пользователя) введите приведенные ниже данные действительной учетной записи Azure AD, которую необходимо подготовить.
    ...
    i. Выберите значение для параметра **Язык**.
