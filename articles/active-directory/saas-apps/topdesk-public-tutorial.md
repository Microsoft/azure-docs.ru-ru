...
1. Войдите на сайт компании **Общедоступная версия TOPdesk** в качестве администратора.
...
5. В подразделе **Общий доступ** раздела настройки **Учетные данные SAML** выполните следующие действия.
...
8. На странице диалогового окна **Помощник по настройке SAML** выполните следующие действия.
    ...
    c. Чтобы отправить файл логотипа, полученный от службы поддержки TOPdesk, в разделе **Значок логотипа** щелкните **Обзор**.
    ...
    д) В текстовом поле **Отображаемое имя** введите имя для конфигурации.
...
2. В меню в верхней части страницы щелкните **TOPdesk \> New \> Support Files \> Person** (&quot;TOPdesk&quot; > &quot;Создать&quot; > &quot;Файлы поддержки&quot; > &quot;Пользователь").
    ...
    ![Person](./media/topdesk-public-tutorial/ic790628.png "Человек")
...
3. В диалоговом окне "Новый пользователь" выполните следующие действия:
    ...
    c. Выберите **Сайт** для учетной записи.
