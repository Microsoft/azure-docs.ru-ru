...
В большинстве случаев гибридное присоединение к Azure AD имеет приоритет над зарегистрированным состоянием Azure AD, в результате чего устройство считается гибридным присоединяемым к Azure AD для проверки подлинности и оценки условного доступа. Однако иногда это двойное состояние может привести к недетерминированной оценке устройства и вызвать проблемы доступа. Мы настоятельно рекомендуем выполнить обновление до Windows 10 версии 1803 и выше, где мы автоматически очищающи зарегистрированное состояние Azure AD. Узнайте, как [избежать или очистить это двойное состояние на компьютере с Windows 10](hybrid-azuread-join-plan.md#review-things-you-should-know). 
