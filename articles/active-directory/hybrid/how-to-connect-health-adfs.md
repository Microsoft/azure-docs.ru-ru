...
Приведенная ниже информация относится к мониторингу инфраструктуры AD FS с помощью Azure AD Connect Health. Сведения о мониторинге Azure AD Connect (синхронизация) с помощью Azure AD Connect Health см. в разделе [Использование Azure AD Connect Health для синхронизации](how-to-connect-health-sync.md). Кроме того, сведения о мониторинге доменных служб Active Directory с помощью Azure AD Connect Health см. в разделе [Использование Azure AD Connect Health с AD DS](how-to-connect-health-adds.md).
...
![Снимок экрана, на котором показана страница "Оповещения" Azure AD Connect Health с выбранным оповещением и отображается окно "Сведения об оповещении".](./media/how-to-connect-health-adfs/alert2.png)
...
![Снимок экрана, на котором показана страница "Аналитика использования" Azure AD Connect Health.](./media/how-to-connect-health-adfs/report1.png)
...
![Снимок экрана, на котором показана страница "Мониторинг" производительности Azure AD Connect Health.](./media/how-to-connect-health-adfs/perf1.png)
...
![Снимок экрана, который показывает раздел "Отчеты" с количеством попыток ввода неверного пароля за последние 30 дней.](./media/how-to-connect-health-adfs/report1a.png)
...
* [Отчет о ненадежном IP-адресе](how-to-connect-health-adfs-risky-ip.md)