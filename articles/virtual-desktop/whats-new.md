...
## <a name="windows-virtual-desktop-agent-updates"></a>Обновления агента Виртуального рабочего стола Windows

Агент Виртуального рабочего стола Windows обновляется по крайней мере один раз в месяц.

Изменения в агенте Виртуального рабочего стола Windows:

- Версия 1.0.2866.1500. Это обновление было выпущено 26 марта 2021 года и устранило проблемы с проверками работоспособности стека.
- Версия 1.0.2800.2802. Это обновление было выпущено 10 марта 2021 года и содержит общие улучшения и исправления ошибок.
- Версия 1.0.2800.2800. Это обновление было выпущено 2 марта 2021 года и устранило проблемы с обратным подключением.
- Версия 1.0.2800.2700. Это обновление было выпущено 10 февраля 2021 года и содержит общие улучшения и исправления ошибок.
- Версия 1.0.2800.2700. Это обновление было выпущено в 4 февраля 2021 года и устранило проблемы с оркестрацией с отказом в доступе.
...
Ниже перечислены изменения за февраль 2021 г.
