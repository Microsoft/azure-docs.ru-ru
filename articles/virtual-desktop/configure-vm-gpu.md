...
Чтобы воспользоваться возможностями GPU виртуальных машин Azure серии N на Виртуальном рабочем столе Windows, необходимо установить соответствующие графические драйверы. Следуйте инструкциям в разделе [Поддерживаемые операционные системы и драйверы](../virtual-machines/sizes-gpu.md#supported-operating-systems-and-drivers) для установки драйверов. Поддерживаются только драйверы, распространяемые Azure.

* Для виртуальных машин Azure серии NV или серии NVv3, только драйверы NVIDIA GRID, а не драйверы NVIDIA CUDA, поддерживают ускорение GPU для большинства приложений и пользовательского интерфейса Windows. Если вы решили установить драйверы вручную, обязательно установите драйверы сетки. Если вы решили установить драйверы с помощью расширения виртуальной машины Azure, для этих размеров виртуальных машин будут автоматически установлены драйверы.
* Для виртуальных машин Azure серии NVv4 установите драйверы AMD, предоставляемые Azure. Вы можете установить их автоматически с помощью расширения виртуальной машины Azure или установить их вручную.
