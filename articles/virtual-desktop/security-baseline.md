...
- [Резервное копирование ключей Key Vault в Azure](/powershell/module/azurerm.keyvault/backup-azurekeyvaultkey?preserve-view=true&view=azurermps-6.13.0)
...
- [Реализация безопасности](../backup/backup-azure-restore-files-from-vm.md#security-implementations)
...
- [Azure Security Benchmark — управление удостоверениями](../automation/update-management/overview.md)
