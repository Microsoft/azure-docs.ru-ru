...
На этом этапе поставщик удостоверений Amazon настроен, но еще не доступен ни на одной из страниц входа. Чтобы добавить поставщик удостоверений Amazon в поток пользователя, выполните следующие действия.
