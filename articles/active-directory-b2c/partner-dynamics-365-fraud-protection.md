...
Разверните [предоставленный код API](https://github.com/azure-ad-b2c/partner-integrations/tree/master/samples/Dynamics-Fraud-Protection/API) в службе Azure. Код можно [опубликовать из Visual Studio](/visualstudio/deployment/quickstart-deploy-to-azure).
