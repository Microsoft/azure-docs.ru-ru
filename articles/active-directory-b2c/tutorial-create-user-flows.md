...
Чтобы включить [самостоятельный сброс пароля](add-password-reset-policy.md) для пользовательского потока регистрации или входа:
...
1. Проверьте адрес электронной почты для созданной ранее учетной записи и щелкните **Продолжить**.
...
Затем узнайте, как использовать Azure AD B2C для входа и регистрации пользователей в приложении. Перейдите к приведенному ниже веб-приложению ASP.NET или к другому приложению в содержании в разделе **Аутентификация пользователей**.

> [!div class="nextstepaction"]
> [Учебник. Включение в веб-приложении аутентификации с помощью Azure AD B2C >](tutorial-web-app-dotnet.md)
