...
Кроме того, вы можете узнать больше о том, как [определить технический профиль условного доступа в пользовательской политике](conditional-access-technical-profile.md).
