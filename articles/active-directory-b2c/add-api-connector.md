...
| status      | Целое число/строка | Да      | `400`Для ответа ValidationError должно быть значение или `"400"` .  |
| userMessage | Строка  | Да      | Сообщение, отображаемое для пользователя.                                            |
