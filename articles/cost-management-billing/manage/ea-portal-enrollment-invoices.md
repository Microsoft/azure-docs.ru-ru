...
Чтобы предотвратить автоматическое создание номеров заказов на покупку каждый месяц, можно заблокировать определенный номер заказа на покупку. См. раздел о [блокировке номера заказа на покупку](#lock-po-number-to-prevent-automatic-update-in-upcoming-billing-cycles).

### <a name="update-the-azure-services-purchase-order-number"></a>Обновление номера заказа на покупку служб Azure
...
### <a name="update-the-azure-marketplace-purchase-order-number"></a>Обновление номера заказа на покупку в Azure Marketplace
...
### <a name="lock-po-number-to-prevent-automatic-update-in-upcoming-billing-cycles"></a>Блокировка номера заказа на покупку для предотвращения его автоматического обновления в предстоящих периодах выставления счетов

После блокировки номера заказа на покупку он остается заблокированным для всех новых счетов, и вам не нужно обновлять этот номер.

1.  На портале Azure Enterprise Portal выберите **Отчет** > **Сведения об использовании**.
2.  Выберите **Edit PO Numbers** (Изменить номера заказов на покупку) в верхнем правом углу.
3.  Введите новый номер заказа на покупку в поле **Номер заказа на покупку**.
4.  Установите флажок **Lock PO number** (Заблокировать номер заказа на покупку).
5.  Щелкните **Сохранить**, чтобы отправить изменения.  
    :::image type="content" source="./media/ea-portal-enrollment-invoices/lock-po.png" alt-text="Снимок экрана, отображающий поле &quot;View/Edit PO Numbers&quot; (Просмотр или изменение номеров заказов на покупку)." lightbox="./media/ea-portal-enrollment-invoices/lock-po.png" :::
