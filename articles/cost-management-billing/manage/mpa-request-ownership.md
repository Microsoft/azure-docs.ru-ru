...
* Доступ к переданным подпискам нужно организовать совместно с клиентом. [Назначение ролей Azure с помощью портала Azure](../../role-based-access-control/role-assignments-portal.md)