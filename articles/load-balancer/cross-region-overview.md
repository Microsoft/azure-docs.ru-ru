...
**Домашняя область** — это место, где развернута подсистема балансировки нагрузки между регионами или общедоступный IP-адрес глобального уровня. Этот регион не влияет на то, как будет маршрутизироваться трафик. Если домашняя область выходит из строя, то поток трафика не затрагивается.
...
> [!NOTE]
> Вы можете развернуть только подсистему балансировки нагрузки между регионами или общедоступные IP-адреса в глобальном уровне в одном из семи регионов выше.
