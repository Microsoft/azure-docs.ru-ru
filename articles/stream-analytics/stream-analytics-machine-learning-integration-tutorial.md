...
4. После завершения развертывания перейдите к своей учетной записи хранения. Выберите элемент **Контейнеры** в разделе **Служба BLOB-объектов**. Затем выберите **+ контейнер** , чтобы создать новый контейнер.
