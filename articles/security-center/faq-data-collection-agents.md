...
- **Автономный защитник Azure** — центр безопасности включает решение "SecurityCenterFree" в рабочей области по умолчанию. Плата за использование защитника Azure не взимается.

- **Защитник Azure в** — центр безопасности включает решение "безопасность" в рабочей области по умолчанию.

Сведения о ценах на выбранную валюту и в соответствии с регионом см. на странице [цен на центр безопасности](https://azure.microsoft.com/pricing/details/security-center/).
...
1. Откройте страницу **автоматической подготовки** .
...
Если настроенная рабочая область является рабочей областью пользователя (не является рабочей областью по умолчанию центра безопасности), необходимо установить в ней решение "Security" или "SecurityCenterFree" для центра безопасности, чтобы начать обработку событий с виртуальных машин и компьютеров, передающих данные в эту рабочую область.
