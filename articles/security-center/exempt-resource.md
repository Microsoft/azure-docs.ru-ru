...
| Ограничения                    | Исключения можно создавать только для рекомендаций по умолчанию, которые входят в стандартную инициативу центра безопасности Azure. Рекомендации, созданные из пользовательских инициатив, не могут быть исключены. Узнайте больше о связях между [политиками, инициативами и рекомендациями](security-policy-concept.md). |
...
> [!NOTE]
> Исключения можно создавать только для рекомендаций по умолчанию, которые входят в стандартную инициативу центра безопасности Azure. Рекомендации, которые создаются из любых пользовательских инициатив, назначенных для ваших подписок, не могут быть исключены. Узнайте больше о связях между [политиками, инициативами и рекомендациями](security-policy-concept.md).
