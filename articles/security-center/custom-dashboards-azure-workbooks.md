...
:::image type="content" source="media/custom-dashboards-azure-workbooks/secure-score-over-time-snip.png" alt-text="Отчет о безопасности оценки за период времени":::
...
- **Оценка безопасности** с учетом времени — контроль оценок подписок и изменений в рекомендациях для ресурсов
- **Обновления системы** — Просмотр отсутствующих обновлений системы по ресурсам, ОС, уровню серьезности и др.
- **Результаты оценки уязвимостей** — просмотрите результаты проверок уязвимостей ресурсов Azure.
...
- [Проверка компьютеров с помощью встроенного сканера ва](deploy-vulnerability-assessment-vm.md)
