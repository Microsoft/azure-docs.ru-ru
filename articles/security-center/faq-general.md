...
Инициатива по обеспечению безопасности определяет набор элементов управления (политик), рекомендуемых для ресурсов в указанной подписке. В центре безопасности Azure вы назначаете инициативы для подписок Azure в соответствии с требованиями к безопасности вашей компании, типом приложений или уровнем конфиденциальности данных в каждой подписке.

Политики безопасности, включенные в центре безопасности Azure, позволяют получать рекомендации по обеспечению безопасности и осуществлять мониторинг. Дополнительные сведения см. в разделе [что такое политики безопасности, инициативы и рекомендации?](security-policy-concept.md)
