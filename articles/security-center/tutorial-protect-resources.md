...
Для выполнения инструкций из этого руководства необходимо включить Azure Defender. Доступна бесплатная пробная версия. Инструкции по обновлению см. в статье [Краткое руководство. Включение Azure Defender](enable-azure-defender.md).
