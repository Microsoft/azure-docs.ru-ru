...
|Облако.|![Да](./media/icons/yes-icon.png) Коммерческие облака<br>![Да](./media/icons/yes-icon.png) US Gov и другие правительственные облака<br>![Да](./media/icons/yes-icon.png) China Gov|
|||
...
Оповещения и рекомендации по безопасности хранятся в таблицах *секуритялерт* и *секуритирекоммендатион* соответственно. 
