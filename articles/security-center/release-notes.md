...
- [Улучшения страницы рекомендаций](#recommendations-page-enhancements)
...
### <a name="recommendations-page-enhancements"></a>Улучшения страницы рекомендаций 
...
1. Значки заменяют теги, такие как **Быстрое исправление** и **Предварительный просмотр**.
1. Новый столбец, в котором показана [инициатива политики](security-policy-concept.md), связанная с каждой рекомендацией. Отображается, если параметр Group by controls (Группировать по элементам управления) отключен.

:::image type="content" source="media/release-notes/recommendations-grid-enhancements.png" alt-text="Усовершенствования для страницы рекомендаций Центра безопасности Azure — март 2021 года" lightbox="media/release-notes/recommendations-grid-enhancements.png":::

:::image type="content" source="media/release-notes/recommendations-grid-enhancements-initiatives.png" alt-text="Неструктурированный список усовершенствований для страницы рекомендаций Центра безопасности Azure — март 2021 года" lightbox="media/release-notes/recommendations-grid-enhancements-initiatives.png":::
