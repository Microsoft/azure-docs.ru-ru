...
- Ненормальное поведение связи
- Настраиваемые оповещения
- Удаленный доступ.
- Аномальное поведение связи HTTP
- Обнаружение
- Команды перезапуска и завершения
- Аутентификация
- Изменение встроенного по
- Сканирование
- Поведение неавторизованного взаимодействия
- Недопустимые команды
- Трафик датчика
- Аномалии пропускной способности
- Доступ к Интернету
- Подозрение вредоносных программ
- Переполнение буфера 
- Сбои операций
- Подозрение вредоносных действий
- Сбои команд
