...
| Тип развертывания | Корпоративный | Корпорация | Монтирование в стойку SMB| Износоустойчивое SMB|
|--|--|--|--|--|
...
| Моделирование | HPE ProLiant DL360 | HPE ProLiant DL20 | HPE ProLiant DL20 | HPE EL300 |
...
| Тип развертывания | Корпоративный | Корпорация | SMB |
|--|--|--|--|
...
## <a name="smb-rugged-hpe-edgeline-el300"></a>SMB rugged: HPE Еджелине EL300
...
| Память | SSD Мсата Wide температура 3ME3 128 ГБ |
...
| Тип | Корпоративный | Корпорация | SMB |
|--|--|--|--|
| vCPU | 32 | 8 | 4 |
...
| Моделирование | Dell PowerEdge R340 XL |
