...
1. Перейдите к IP-адресу, полученному для локальной консоли управления во время установки системы.
 
1. Введите имя пользователя и пароль, полученные для локальной консоли управления во время установки системы. 


Если вы забыли пароль, выберите параметр **восстановить пароль**  и ознакомьтесь с инструкциями по восстановлению пароля в разделе [Восстановление пароля](how-to-manage-the-on-premises-management-console.md#password-recovery) .

## <a name="get-and-upload-an-activation-file"></a>Получение и передача файла активации

После первого входа в систему необходимо активировать локальную консоль управления, получив и открыв файл активации. 

Чтобы получить файл активации, выполните следующие действия.

1. Перейдите на страницу **цен** на портале защитника Azure для IOT. 
1. Выберите подписку, чтобы связать локальную консоль управления с.
...
1. Перейдите на страницу **системные параметры** в локальной консоли управления.
1. Выберите значок **активации** :::image type="icon" source="media/how-to-manage-sensors-from-the-on-premises-management-console/activation-icon.png" border="false"::: .
1. Выберите **выбрать файл** и выберите скачанный файл.

После начальной активации число отслеживаемых устройств может превышать количество зафиксированных устройств, определенных во время адаптации. Это происходит при подключении дополнительных датчиков к консоли управления. При обнаружении несоответствия между числом отслеживаемых устройств и количеством зафиксированных устройств в консоли управления появится предупреждение. Если это происходит, отправьте новый файл активации.
...
1. Введите парольную фразу и при необходимости отправьте PEM-файл.
