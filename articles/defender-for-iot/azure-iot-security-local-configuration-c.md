...
| Идентификация | "DPS", "Секуритимодуле", "Device" | Удостоверение проверки подлинности — DP, если проверка подлинности выполняется через службу DPS, Секуритимодуле при проверке подлинности с помощью защитника IoT-Micro-аженткредентиалс или устройства, если проверка подлинности выполняется с учетными данными |
