...
> [!IMPORTANT] 
> Azure NetApp Files поведение подготовки пула томов и емкости изменится на *ручной* и *управляемый* механизм. **Начиная с 1 апреля 2021 (Обновлено), размер тома (квота) будет управлять производительностью пропускной способности, а также подготовленной емкостью, а базовые пулы емкости больше не будут автоматически увеличиваться.** 
