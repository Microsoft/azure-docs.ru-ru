...
## <a name="failed-communication-with-azure-netapp-files"></a>Сбой связи с Azure NetApp Files

При проверке связи с Azure NetApp Files может произойти сбой или тайм-аут связи.  Убедитесь, что правила брандмауэра не блокируют исходящий трафик из системы, в которой выполняется Азакснап, на следующие адреса и порты TCP/IP:-

- (HTTPS://) управление. Azure. com: 443
- (HTTPS://) Login. микрософтонлине. com: 443 
