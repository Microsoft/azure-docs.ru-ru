...
Следующий пример имеет выходные данные для **Azure NetApp Files**. Обратите внимание на сокращенную информацию с этой командой, так как эта информация не предоставляется службой.
