...
2.  Чтобы создать правило политики экспорта, укажите следующие сведения.   
    ...
    * **Разрешенные клиенты**: Укажите значение в одном из следующих форматов:  
      ...
      * IPv4-адрес с маской подсети, выраженный в виде числа битов. Например, `10.1.12.10/4`.
      * IP-адреса, разделенные запятыми. Можно ввести несколько IP-адресов узлов в одном правиле, разделяя их запятыми. Например, `10.1.12.25,10.1.12.28,10.1.12.29`.
