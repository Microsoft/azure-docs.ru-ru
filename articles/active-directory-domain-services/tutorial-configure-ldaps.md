...
1. Конфигурация контроллера домена.
1. Конфигурация клиента.
1. Сеть
1. Создание сеанса TLS.
...
Дополнительные сведения см. в статье [Подтверждение протокола TLS](https://docs.microsoft.com/windows/win32/secauthn/tls-handshake-protocol).
