---
title: Руководство. Мониторинг и настройка отдельного сервера Базы данных Azure для PostgreSQL
...
---
# <a name="tutorial-monitor-and-tune-azure-database-for-postgresql---single-server"></a>Руководство. Мониторинг и настройка отдельного сервера Базы данных Azure для PostgreSQL
...
[Хранилище запросов](concepts-query-store.md) записывает историю запросов, а также собирает статистику по серверу и сохраняет ее в базу данных **azure_sys** на вашем сервере. Это подключаемая возможность. Чтобы включить его, сделайте следующее:
