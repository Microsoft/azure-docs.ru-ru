...
- После настройки размер хранилища нельзя уменьшить. Вам пришлось бы создать новый сервер с требуемым размером хранилища и выполнить ручное копирование и восстановление для переноса баз данных.
