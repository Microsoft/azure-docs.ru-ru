...
Создайте в подписке удостоверение, используя команду [az identity create](/cli/azure/identity#az_identity_create). Вы можете использовать ту же группу ресурсов, в которой работает ваша виртуальная машина, или другую.

```azurecli-interactive
az identity create --resource-group myResourceGroup --name myManagedIdentity
```

Чтобы настроить удостоверение на следующих шагах, выполните команду [az identity show](/cli/azure/identity#az_identity_show) для сохранения идентификаторов ресурса и клиента удостоверения в переменных.
...
Теперь можно назначить виртуальной машине удостоверение, назначаемое пользователем, с помощью команды [az vm identity assign](/cli/azure/vm/identity#az_vm_identity_assign):
