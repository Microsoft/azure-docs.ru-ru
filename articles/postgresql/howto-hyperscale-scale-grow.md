...
> [!NOTE]
> После увеличения и сохранения число рабочих узлов невозможно будет уменьшить с помощью ползунка.
...
## <a name="increase-or-decrease-vcores-on-nodes"></a>Увеличение или уменьшение числа виртуальных ядер на узлах
