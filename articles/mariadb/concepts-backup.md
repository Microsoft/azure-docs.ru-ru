...
Эти файлы резервных копий не предоставляются пользователю и их нельзя экспортировать. Эти резервные копии можно использовать только для операций восстановления в базе данных Azure для MariaDB. [Mysqldump](howto-migrate-dump-restore.md) можно использовать для копирования базы данных.
