...
- До пяти узлов с отказоустойчивым кластером на кластер
...
- [Отказоустойчивая кластеризация в Windows Server](/windows-server/failover-clustering/failover-clustering-overview)
...
- Настройка решения для резервного копирования.
  ...
  - [Решения резервного копирования для виртуальных машин Azure VMware](./ecosystem-back-up-vms.md)