...
Чтобы предотвратить создание ролей, которые не могут быть назначены или удалены, рекомендуется клонировать роль CloudAdmin в качестве основания для создания новых пользовательских ролей.
