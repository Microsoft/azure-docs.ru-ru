...
Корпорация Майкрософт соблюдает безопасный процесс закупок. Мы контролируем всю цепочку, обеспечивая сохранность и гарантируя, что в центры обработки данных всегда поступает конкретное устройство, которое было заказано и отправлено. Устройства находятся в серийных контейнерах событий, которые являются пластиковыми. Они хранятся в безопасном хранилище, пока не будут введены в эксплуатацию в галерее данных центра обработки данных.  Стойки с устройствами HSM считаются особо важными для бизнеса. Все устройства заблокированы и постоянно находятся под видеонаблюдением (передняя и задняя панели).
