...
1. Перейдите к своей учетной записи хранения и выберите **файловые ресурсы** в разделе **Файловая служба**.
1. Выберите **включено** для **обратимого удаления для всех файловых ресурсов**.
...
:::image type="content" source="media/storage-how-to-recover-deleted-account/enable-soft-delete-files.png" alt-text="Снимок экрана: область параметров обратимого удаления учетной записи хранения. Выделите раздел обратимое удаление файловых ресурсов, включите переключатель, задайте срок хранения и сохраните. Это приведет к включению обратимого удаления для всех файловых ресурсов в вашей учетной записи хранения.":::
...
Если вы хотите отменить использование обратимого удаления, выполните следующие инструкции. Чтобы окончательно удалить файловый ресурс, который был обратимо удален, необходимо отменить его удаление, отключить обратимое удаление, а затем удалить его снова. 

# <a name="portal"></a>[Портал](#tab/azure-portal)

1. Перейдите к своей учетной записи хранения и выберите **файловые ресурсы** в разделе **Файловая служба**.
1. Выберите **отключено** для **обратимого удаления для всех файловых ресурсов**.
1. Выберите **Сохранить**, чтобы подтвердить параметры хранения данных.
