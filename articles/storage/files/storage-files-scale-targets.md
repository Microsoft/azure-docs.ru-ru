...
| Атрибут | Учетные записи хранения GPv2 (Standard) | Учетные записи хранения Филестораже (Premium) |
|-|-|-|
...
| Атрибут | Стандартные общие папки<sup>1</sup> | Общие папки ценовой категории "Премиум" |
|-|-|-|
...
| Атрибут | Файлы в стандартных файловых ресурсах  | Файлы в общих файловых ресурсах уровня "Премиум"  |
|-|-|-|
