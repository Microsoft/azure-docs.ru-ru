...
:::row:::
    ...
    :::column-end:::
    :::column:::
        В этом видео показано, как безопасно предоставлять общие папки Azure непосредственно информационным работникам и приложениям за пять простых шагов. В разделах ниже приведены ссылки и дополнительный контекст для документации, указанной в видео.
   :::column-end:::
:::row-end:::
