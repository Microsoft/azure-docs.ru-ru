...
* Общие сведения о гибкости политик распределения по [уровням облака](storage-sync-cloud-tiering-overview.md) .
