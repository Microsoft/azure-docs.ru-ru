...
| Аудит | Служба синхронизации файлов Azure | Службе синхронизации хранилища требуется по крайней мере одна частная конечная точка. Дополнительные сведения см. [в разделе Создание частной конечной точки службы синхронизации хранилища](#create-the-storage-sync-service-private-endpoint) . | Синхронизация файлов Azure должны использовать закрытую ссылку |
| Изменить | Служба синхронизации файлов Azure | Отключите общедоступную конечную точку службы синхронизации хранилища. | Изменить — настроить Синхронизация файлов Azure для отключения доступа к общедоступной сети |
| Развертывание | Служба синхронизации файлов Azure | Разверните закрытую конечную точку для службы синхронизации хранилища. | Настройка Синхронизация файлов Azure с частными конечными точками |
| Развертывание | Служба синхронизации файлов Azure | Разверните запись A в зоне DNS privatelink.afs.azure.net. | Настройка Синхронизация файлов Azure для использования частных зон DNS |
