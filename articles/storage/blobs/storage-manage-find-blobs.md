...
> [!IMPORTANT]
> В настоящее время Теги индекса BLOB-объектов доступны в **предварительной версии** и доступны во всех общедоступных регионах. Ознакомьтесь с [дополнительными условиями использования Microsoft Azure](https://azure.microsoft.com/support/legal/preview-supplemental-terms/) предварительных версий для юридических условий, которые относятся к функциям Azure, которые доступны в бета-версии, предварительном просмотре или еще не включены в общедоступную версию.
...
В настоящее время Теги индекса BLOB-объектов доступны во всех общедоступных регионах.
