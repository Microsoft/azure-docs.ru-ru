...
Включение этих функций может привести к дополнительным издержкам. Прежде чем включить восстановление на момент времени и необходимые компоненты, убедитесь, что вы понимаете влияние на выставление счетов.
...
Для включения восстановления на момент времени не взимается плата. Однако включение восстановления на момент времени позволяет также включить управление версиями BLOB-объектов, обратимое удаление и веб-канал изменений, каждый из которых может привести к дополнительным издержкам.
