...
ms.locfileid: "104800750"
---
# <a name="soft-delete-for-containers-preview"></a>Обратимое удаление для контейнеров (Предварительная версия)

Обратимое удаление для контейнеров (Предварительная версия) защищает данные от случайного или злонамеренного удаления. Если для учетной записи хранения включено обратимое удаление контейнеров, то все удаленные контейнеры и их содержимое хранятся в службе хранилища Azure в течение заданного периода. В течение периода хранения можно будет восстановить удаленные ранее контейнеры. Вместе с контейнером восстанавливаются все большие двоичные объекты, хранившиеся в этом контейнере на момент его удаления.
...
> [!WARNING]
> Обратимое удаление контейнера может восстанавливать только целые контейнеры и большие двоичные объекты, содержащиеся во время удаления. Невозможно восстановить удаленный большой двоичный объект в контейнере с помощью обратимого удаления контейнера.
