...
> [!IMPORTANT]
> В настоящее время Теги индексов больших двоичных объектов доступны в **предварительной версии** и доступны в **центральных регионах Канады**, **Восточной Азии**, **центральном регионе Франции** и **Франции** . Ознакомьтесь с [дополнительными условиями использования Microsoft Azure](https://azure.microsoft.com/support/legal/preview-supplemental-terms/) предварительных версий для юридических условий, которые относятся к функциям Azure, которые доступны в бета-версии, предварительном просмотре или еще не включены в общедоступную версию.
