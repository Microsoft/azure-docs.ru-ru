...
Ниже приводятся предложения для соответствия требованиям в службе хранилища Azure, чтобы гарантировать соответствие вашей службы при использовании службы хранилища Azure. Они применимы к следующим предложениям службы хранилища Azure: большие двоичные объекты (ADLS 2-го поколения), файлы, очереди, таблицы, диски, подлежащий хранению и хранилище класса Premium.
