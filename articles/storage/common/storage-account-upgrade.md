...
## <a name="upgrade-an-account"></a>Обновление учетной записи

Чтобы обновить учетную запись общего назначения версии v1 или хранилища BLOB-объектов до учетной записи общего назначения v2, используйте портал Azure, PowerShell или Azure CLI.
