...
Azure также поддерживает закрытое и безопасное подключение к ресурсам PaaS (например, службе хранилища Azure и базе данных SQL) из виртуальной сети Azure с помощью [частной ссылки Azure](../../private-link/private-link-overview.md). Ресурс PaaS сопоставляется с [частной конечной точкой](../../private-link/private-endpoint-overview.md) в виртуальной сети. Связь между частной конечной точкой в виртуальной сети и ресурсом PaaS использует магистральную сеть Майкрософт и не переключается через общедоступный Интернет. Предоставление доступа к службе через общедоступный Интернет больше не требуется. Вы также можете использовать частную ссылку Azure для доступа к службам, принадлежащим заказчику, и партнерской службе Azure в виртуальной сети.  Кроме того, Частная ссылка Azure позволяет создать собственную [службу частной связи](../../private-link/private-link-service-overview.md) в виртуальной сети и предоставить ее своим клиентам в частном порядке в своих виртуальных сетях. Настройка и потребление с использованием Приватного канала Azure согласованы между службами Azure PaaS, клиентскими и общими партнерскими службами.
