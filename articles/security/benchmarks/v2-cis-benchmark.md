...
:::image type="content" source="./media/asb-cis-mapping.png" alt-text="Сопоставление тестов производительности ASB и CIS":::

Для получения любых вопросов или комментариев по сопоставлению можно [отправить нам сообщение электронной почты](mailto:benchmarkfeedback@microsoft.com?subject=Benchmark%20Feedback).