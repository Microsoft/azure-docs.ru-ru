...
Чтобы просмотреть подходящую встроенную политику Azure, ознакомьтесь со статьей [сведения о встроенной инициативе по обеспечению безопасности в Azure: реагирование на инциденты](../../governance/policy/samples/azure-security-benchmark.md#incident-response)
