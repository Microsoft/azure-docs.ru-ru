...
- **Аналитика поведения машинного обучения**
    ...
    >
    > - Создав и включив правила на основе шаблонов аналитики поведения машинного обучения, **вы предоставляете корпорации Майкрософт разрешение на копирование полученных данных за пределами вашей рабочей области "Sentinel" Azure, которые** необходимы для обработки в механизмах и моделях машинного обучения.
