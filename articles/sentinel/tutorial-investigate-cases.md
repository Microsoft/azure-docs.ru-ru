...
- Вы сможете исследовать инцидент только в том случае, если вы использовали поля сопоставления сущностей при настройке правила аналитики. Для работы с графом исследования требуется, чтобы исходный инцидент включал в себя сущности.
