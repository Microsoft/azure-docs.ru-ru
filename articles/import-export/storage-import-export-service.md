...
> Для внешних поставок (за пределами страны или региона центра обработки данных) вы можете поделиться учетной записью международной перевозчика.
 ...
 ![Рисунок 1. Процесс выполнения задания импорта](./media/storage-import-export-service/import-job.png)
...
> Для внешних поставок (за пределами страны или региона центра обработки данных) вы можете поделиться учетной записью международной перевозчика.
 ...
 ![Рисунок 2. Процесс выполнения задания экспорта](./media/storage-import-export-service/export-job.png)
...
|Центрально-северная часть США     |  Юго-Восточная часть Австралии       | Brazil South        | южная часть Соединенного Королевства        |
