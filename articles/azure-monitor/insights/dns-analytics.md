...
В рабочей области Log Analytics в портал Azure выберите **Сводка по рабочей области** , а затем щелкните плитку **аналитика DNS** . На панели мониторинга решения щелкните **Конфигурация**, чтобы открыть страницу "Конфигурация аналитики DNS". В конфигурацию можно внести два типа изменений:
