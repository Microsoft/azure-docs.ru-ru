...
## <a name="onboarded-resources"></a>Подключенные ресурсы 

Интегрированные ресурсы имеют встроенные книги и представления зависимостей. В настоящее время подключенные ресурсы — это виртуальная Глобальная сеть, шлюз приложений, Load Balancer и ExpressRoute.
