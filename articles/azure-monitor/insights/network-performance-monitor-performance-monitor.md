...
> [!IMPORTANT]
> Начиная с 1 июля 2021 г. вы не сможете добавлять новые тесты в существующую рабочую область или включать новую рабочую область в "Монитор производительности сети". Вы сможете продолжить использование тестов, созданных до 1 июля 2021 г. Чтобы минимизировать прерывание ваших текущих рабочих нагрузок, необходимо выполнить [переход с "Монитора производительности сети" на новый "Монитор подключений"](../../network-watcher/migrate-to-connection-monitor-from-network-performance-monitor.md) в Наблюдателе за сетями Azure до 29 февраля 2024 г.
