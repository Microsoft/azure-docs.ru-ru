...
Вы можете использовать [Обозреватель метрик](../essentials/metrics-getting-started.md) , чтобы выработать приведенные выше метрики в одном месте. На диаграмме должна отобразиться:
