...
> [!NOTE]
> Плитки в представлениях основаны на [запросах журналов](../logs/log-query-overview.md) в рабочей области log Analytics. В настоящее время они не поддерживают [запросы перекрестных ресурсов](../logs/cross-workspace-query.md) для получения данных из Application Insights.
...
* Сведения о [запросах журналов](../logs/log-query-overview.md) для поддержки запросов на плитках.
