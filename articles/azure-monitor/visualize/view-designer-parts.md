...
> [!NOTE]
> Части в представлениях основаны на [запросах журналов](../logs/log-query-overview.md) в рабочей области log Analytics. В настоящее время они не поддерживают [запросы перекрестных ресурсов](../logs/cross-workspace-query.md) для получения данных из Application Insights.
...
Навигация по щелчку позволяет определить, какое действие будет выполнено, если щелкнуть заголовок или элемент списка в представлении.  Это приведет к открытию запроса в [log Analytics](../logs/log-query-overview.md) или запуску другого представления.
...
* Сведения о [запросах журналов](../logs/log-query-overview.md) для поддержки запросов в частях визуализации.