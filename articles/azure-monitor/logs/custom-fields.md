...
> [!NOTE]
> В этой статье описывается, как анализировать текстовые данные в Log Analytics рабочей области по мере их сбора. Рекомендуется анализировать текстовые данные в фильтре запроса после их сбора, следуя рекомендациям, описанным в разделе [анализ текстовых данных в Azure Monitor](./parse-text.md). Он предоставляет несколько преимуществ по сравнению с использованием настраиваемых полей.
...
* Сведения о [запросах журнала](./log-query-overview.md) для построения запросов с помощью настраиваемых полей для критериев.
