...
| Category  | Группа категорий операций. Может использоваться для фильтрации по типам операций и создания более точного системного аудита и оповещений. Список категорий см. в разделе ниже. |
...
| Служба хранилища | Ошибка   | Не удается получить доступ к учетной записи хранения, так как используемые учетные данные недопустимы.  |
...
- [Собирайте данные аудита запросов](./query-audit.md) для рабочей области.