...
* Централизованное визуализация и анализ данных в [клиентских](cross-workspace-query.md) клиентах с помощью таких средств, как Azure Monitor книги, может привести к более медленной работе, особенно при анализе данных в более чем 50 рабочих областях.
...
* Использование [оповещений](../alerts/alerts-overview.md) для интеграции с существующими системами.
