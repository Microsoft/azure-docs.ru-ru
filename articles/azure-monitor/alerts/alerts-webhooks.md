...
Вы также можете настроить оповещение так, чтобы при его активации в URI веб-перехватчика добавлялись соответствующие сведения. Для этого можно использовать [командлеты Azure PowerShell](../powershell-samples.md#create-metric-alerts), [кроссплатформенный интерфейс командной строки](../cli-samples.md#work-with-alerts) или [REST API Azure Monitor](/rest/api/monitor/alertrules).
