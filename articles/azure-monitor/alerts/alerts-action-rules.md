...
ms.locfileid: "105036787"
---
# <a name="action-rules-preview"></a>Правила действий (Предварительная версия)

Правила действий позволяют добавлять или подавлять группы действий в создаваемых оповещениях. Одно правило может охватывать различные области целевых ресурсов, например, любое оповещение на определенном ресурсе (например, определенную виртуальную машину) или любое оповещение, запущенное для любого ресурса в подписке. При необходимости можно добавить различные фильтры для управления тем, какие оповещения покрываются правилом, и определить расписание для него, например, чтобы оно действовало только в рабочее время или в течение периода планового обслуживания.
...
> [!NOTE]
> Правила действий не применяются к оповещениям о работоспособности служб Azure.
...
_Примечание. Вы можете получить правильный идентификатор правила генерации оповещений, перечисляя правила генерации оповещений из интерфейса командной строки или открыв определенное правило генерации оповещений на портале, щелкнув "Свойства" и скопировав значение "идентификатор ресурса"._
* **Состояние монитора**  
Это правило будет применяться только к событиям предупреждений с указанным условием монитора — " **срабатывает** " или " **разрешено**".
* **Описание**  
