...
| **Службы и**<br>**features**<br>**поддерживается** | Log Analytics<br>Обозреватель метрик | Обозреватель метрик | Аналитика виртуальных машин<br>Log Analytics<br>Служба автоматизации Azure<br>Центр безопасности Azure<br>Azure Sentinel | Аналитика виртуальных машин<br>Сопоставление служб |
...
|:---|:---|:---|:---|:---|:---|
| **Поддерживаемые среды** | Azure<br>Другое облако (Дуга Azure)<br>Локально (Дуга Azure) | Azure | Azure<br>Другое облако<br>В локальной среде | Azure<br>Другое облако<br>В локальной среде | Azure<br>Другое облако<br>Локальная среда |
...
- Отправка данных сторонним средствам с помощью [концентраторов событий Azure](./diagnostics-extension-stream-event-hubs.md).
- Собирайте [диагностику загрузки](/troubleshoot/azure/virtual-machines/boot-diagnostics) для изучения проблем загрузки виртуальной машины.
