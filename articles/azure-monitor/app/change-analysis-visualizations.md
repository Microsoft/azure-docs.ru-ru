...
Все ресурсы в выбранной подписке отображаются с изменениями за последние 24 часа. Все изменения отображаются со старым значением и новыми значениями, чтобы получить ценные сведения за один взгляд.

![Снимок экрана: колонка "анализ изменений" в портал Azure](./media/change-analysis/change-analysis-standalone-blade.png)

Щелчок изменения для просмотра полного диспетчер ресурсов фрагмента и других свойств.
...
## <a name="diagnose-and-solve-problems-tool"></a>Средство диагностики и устранения проблем
Анализ изменений доступен в виде карточки аналитики в средстве диагностики и устранения проблем. Если при работе с ресурсом возникают проблемы и обнаружены изменения за последние 72 часов, в карточке Insights отображается число изменений. Если щелкнуть просмотреть сведения об изменении сведений, откроется отфильтрованное представление из автономного пользовательского интерфейса анализа изменений.

![Снимок экрана: Просмотр сведений об изменениях в средстве диагностики и устранения неполадок.](./media/change-analysis/change-insight-diagnose-and-solve.png)
