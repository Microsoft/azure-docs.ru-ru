...
ms.locfileid: "93376992"
---
# <a name="java-codeless-application-monitoring-on-premises---azure-monitor-application-insights"></a>Локальное наблюдение за приложением Java Code Monitoring Azure Monitor Application Insights
