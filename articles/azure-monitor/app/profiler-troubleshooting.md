...
Эта ошибка возникает при запуске веб-развертывание из скриптов или из Azure Pipelines. Решение заключается в добавлении следующих параметров развертывания в задачу веб-развертывание:
