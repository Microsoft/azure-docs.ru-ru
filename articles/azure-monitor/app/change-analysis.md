...
ms.locfileid: "104655825"
---
# <a name="use-application-change-analysis-preview-in-azure-monitor"></a>Использование Анализа изменений в приложениях (предварительная версия) в Azure Monitor
...
## <a name="enable-change-analysis-at-scale-for-web-app-in-guest-file-and-environment-variable-changes"></a>Включение анализа изменений в масштабе для веб-приложения в гостевых файлах и переменных среды
