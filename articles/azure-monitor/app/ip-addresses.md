...
| Назначение | URI | IP-адрес | порты; |
| --- | --- | --- | --- |
| Пакеты средств разработки CDN JS Application Insights | az416426.vo.msecnd.net<br/>js.monitor.azure.com | Динамический | 80, 443 |

## <a name="action-group-webhooks"></a>Веб-перехватчики для группы действий

Вы можете запросить список IP-адресов, используемых группами действий, с помощью [команды PowerShell Get-азнетворксервицетаг](/powershell/module/az.network/Get-AzNetworkServiceTag).
