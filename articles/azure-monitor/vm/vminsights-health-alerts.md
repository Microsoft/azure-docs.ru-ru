---
title: Оповещения VM insights guest health (предварительная версия)
...
ms.locfileid: "105024614"
---
# <a name="vm-insights-guest-health-alerts-preview"></a>Оповещения VM insights guest health (предварительная версия)
...
Просмотр оповещений, созданных службой работоспособности гостевых систем, с другими [оповещениями в портал Azure](../alerts/alerts-overview.md#alerts-experience). Вы можете выбрать **оповещения** в меню **Azure Monitor** , чтобы просмотреть предупреждения для всех наблюдаемых ресурсов, или выбрать **оповещения** из меню виртуальной машины, чтобы просмотреть предупреждения только для этой виртуальной машины.
