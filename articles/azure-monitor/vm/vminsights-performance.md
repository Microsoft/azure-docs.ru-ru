---
title: Создание диаграммы производительности с помощью VM Insights
...
ms.locfileid: "102046471"
---
# <a name="how-to-chart-performance-with-vm-insights"></a>Создание диаграммы производительности с помощью VM Insights
