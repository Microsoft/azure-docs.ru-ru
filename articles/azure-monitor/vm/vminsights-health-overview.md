---
title: VM insights guest health (предварительная версия)
...
ms.locfileid: "102052132"
---
# <a name="vm-insights-guest-health-preview"></a>VM insights guest health (предварительная версия)
