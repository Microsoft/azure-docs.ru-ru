...
- Если используются виртуальные подключения файлов, проверьте [требования к сети](virtual-file-mount.md#networking-requirements) и убедитесь, что необходимый трафик не заблокирован.
