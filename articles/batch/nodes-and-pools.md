...
> [!WARNING]
> Пулы конфигурации облачных служб являются [устаревшими](https://azure.microsoft.com/updates/azure-batch-cloudserviceconfiguration-pools-will-be-retired-on-29-february-2024/). Вместо этого используйте пулы конфигурации виртуальных машин. Дополнительные сведения см. в статье [Перенос конфигурации пула пакетной службы из облачных служб в виртуальную машину](batch-pool-cloud-service-to-virtual-machine-configuration.md).
