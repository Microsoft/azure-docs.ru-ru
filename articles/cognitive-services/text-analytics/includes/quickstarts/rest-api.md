...
ms.locfileid: "104599108"
---
# <a name="version-31-preview"></a>[Версия 3.1 (предварительная версия)](#tab/version-3-1)

[Справочная документация по версии 3.1](https://westus2.dev.cognitive.microsoft.com/docs/services/TextAnalytics-v3-1-preview-4/)
...
> [!NOTE]
> Приведенный ниже пример включает запрос к функции интеллектуального анализа мнений в рамках анализа тональности с использованием параметра `opinionMining=true`. Это обеспечивает более детализированные сведения о мнениях (прилагательные), связанных с целевыми объектами (существительные) в тексте.
