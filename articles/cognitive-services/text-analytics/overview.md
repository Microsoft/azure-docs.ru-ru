...
Интеллектуальный анализ данных — это функция анализа тональности (начиная с версии 3.1 — предварительная версия). Эта функция также известна как анализ тональности на основе аспекта в средствах обработки естественного языка (NLP). Она предоставляет более детализированные сведения о мнениях, связанных со словами (например, атрибуты продуктов или услуг) в тексте.
