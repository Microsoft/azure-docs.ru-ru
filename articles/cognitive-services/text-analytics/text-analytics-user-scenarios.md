...
Используйте распознавание именованных сущностей для распознавания персональных и конфиденциальных сведений в документах. Используйте данные, чтобы классифицировать документы или редактировать их для безопасного совместного использования.
