...
> [!IMPORTANT]
> Перейдите на портал Azure. Если ресурсы обучения Пользовательскому визуальному распознаванию, созданные в соответствии с указаниями в разделе **Предварительные требования**, успешно развернуты, нажмите кнопку **Перейти к ресурсу** в разделе **Дальнейшие действия**. Ключ и конечную точку можно найти на странице **ключа и конечной точки** ресурса. 
>
