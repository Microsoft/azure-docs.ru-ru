...
---
# <a name="language-understanding-luis-container-limitations"></a>Ограничения контейнеров Распознавание речи (LUIS)
...
|Неподдерживаемые сущности для всех языков и региональных параметров|[Кэйфрасе](luis-reference-prebuilt-keyphrase.md) предварительно созданную сущность для всех языков и региональных параметров|
