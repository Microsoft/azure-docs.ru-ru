---
title: Запуск иммерсивное средство чтения
titleSuffix: Azure Cognitive Services
description: Узнайте, как запустить иммерсивное средство чтения с помощью JavaScript, Python, Android или iOS. Иммерсивное средство чтения использует проверенные методы для улучшения навыков чтения для средств обучения, новых читателей и учащихся с учетом отличий.
author: metanMSFT
manager: guillasi
...
ms.locfileid: "102620189"
---
# <a name="how-to-launch-the-immersive-reader"></a>Запуск иммерсивное средство чтения

В [обзорной статье](./overview.md) вы узнали о том, что представляет собой иммерсивное средство чтения и каким образом в нем реализованы проверенные методы, улучшающие понимание прочитанного для начинающих, тех, кто изучает язык, и учащихся с особыми потребностями. В этой статье показано, как запустить иммерсивное средство чтения JavaScript, Python, Android или iOS. 
