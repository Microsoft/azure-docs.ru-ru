...
* Висемес- [висемес](how-to-speech-synthesis-viseme.md) используются для представления ключа в наблюдаемой речи (т. е. расположение LIP, жав и дразнящаяся рожица при создании определенного phoneme). Он имеет сильную корреляцию с голосовыми и фонемы. С помощью Висеме в речевом пакете SDK можно создавать данные анимации лиц, которые обычно используются для анимированного взаимодействия с пакетом LIP, образования, развлечений и обслуживания клиентов. 
