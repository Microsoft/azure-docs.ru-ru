...
Понятие [распознавания ключевых слов](./custom-keyword-basics.md) поддерживается в РЕЧЕВОМ пакете SDK. Распознавание ключевых слов — это процесс определения ключевого слова в речи, за которым следует действие после прослуха ключевого слова. Например, "Привет, Кортана!" активировал помощник Кортаны.
...
**Распознавание ключевых слов** доступно на следующих платформах:
  ...
  - Функция распознавания ключевых слов может работать с любым типом микрофона, официальной поддержкой распознавания ключевых слов в настоящее время ограничена только массивами микрофонов, находящихся на оборудовании Azure Kinect DK или в пакете SDK для речевых устройств.
...
Некоторые языки программирования речевого пакета SDK поддерживают звуковые потоки, сжатые с помощью кодеков. Дополнительные сведения см. в разделе <a href="/azure/cognitive-services/speech-service/how-to-use-codec-compressed-audio-input-streams" target="_blank">Использование сжатых входных форматов звука </a>.
