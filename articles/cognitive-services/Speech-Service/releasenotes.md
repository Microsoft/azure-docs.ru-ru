...
- **C++/c #/Жава**: добавлена поддержка получения профиля голоса для сценария распознавания говорящего, чтобы приложение могла сравнивать данные о динамиках с существующим голосовым профилем. Сведения для [C++](https://docs.microsoft.com/cpp/cognitive-services/speech/speakerrecognizer), [C#](https://docs.microsoft.com/dotnet/api/microsoft.cognitiveservices.speech.speakerrecognizer?view=azure-dotnet)и [Java](https://docs.microsoft.com/java/api/com.microsoft.cognitiveservices.speech.speakerrecognizer?view=azure-java-stable). Это решает [проблемы GitHub #808](https://github.com/Azure-Samples/cognitive-services-speech-sdk/issues/808).
...
- **Python**: добавлена поддержка [Python 3,9](https://docs.microsoft.com/azure/cognitive-services/speech-service/quickstarts/setup-platform?pivots=programming-language-python) и удаленная поддержка для Python 3,5 на [конец жизненного цикла Python для 3,5](https://devguide.python.org/devcycle/#end-of-life-branches).
...
- **C#**: Улучшенная точность, удобочитаемость и разделы справочной [документации по c# для улучшения](https://docs.microsoft.com/dotnet/api/microsoft.cognitiveservices.speech?view=azure-dotnet) удобства использования пакета SDK в c#.
...
**Примечание**. Приступая к работе с интерфейсом командной строки службы речи Azure (CLI), см. [здесь](https://docs.microsoft.com/azure/cognitive-services/speech-service/spx-basics). Интерфейс командной строки позволяет использовать службу распознавания речи Azure без написания кода.
