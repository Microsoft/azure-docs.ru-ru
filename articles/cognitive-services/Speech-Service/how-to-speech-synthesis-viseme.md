...
С помощью висемес можно создать более естественный и интеллектуальный помощник по рассылке новостей, более интерактивные игры и мультипликационные символы, а также более интуитивно понятные видеоматериалы по языку. С нарушениями слуха также можно визуально выбирать звуки и речевое содержимое "LIP-Read", которое показывает висемес на анимированном изображении.
