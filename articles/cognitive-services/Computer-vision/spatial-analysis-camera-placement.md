...
Для операции **cognitiveservices. видение. спатиаланалисис-персонкроссинглине** , +/-5 ° — это оптимальный угол монтажа камеры для повышения точности.

Для распознавания масок лиц +/-30 градусов — это оптимальный угол монтажа камеры для высоты камеры от 8 до 12.
