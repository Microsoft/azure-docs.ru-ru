...
| внеттипе | **Прозрачный** или **ICS** | Тип виртуального коммутатора. **Значение по умолчанию**: Transparent. Прозрачный термин относится к внешнему коммутатору, а ICS — к внутреннему коммутатору. |
...
>[!NOTE]
>По умолчанию, если процессу не удается найти внешний коммутатор с именем `External` , он выполнит поиск любого существующего внешнего коммутатора, по которому будет получен IP-адрес. Если внешний коммутатор недоступен, он выполняет поиск внутреннего коммутатора. Если внутренний коммутатор недоступен, он попытается создать параметр по умолчанию, по которому будет получен IP-адрес.
