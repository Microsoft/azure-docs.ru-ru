...
С помощью службы "Записные книжки Azure" вы можете разработать модуль машинного обучения и развернуть его на устройстве, на котором выполняется Azure IoT Edge с контейнерами Linux.
