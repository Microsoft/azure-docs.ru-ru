...
Модуль IoT Edge концентратора выступает в качестве центра Интернета вещей, поэтому может управлять подключениями с других устройств, имеющих удостоверение с одним и тем же центром Интернета вещей. Этот тип шаблона шлюза называется *прозрачным* , так как сообщения могут передаваться из нижестоящих устройств в центр Интернета вещей, как будто между ними нет шлюза.
...
>[!NOTE]
>В IoT Edge версии 1,1 и более ранних IoT Edge устройства не могут быть подчинены IoT Edge шлюза.
>
>Начиная с версии 1,2 IoT Edge, прозрачные шлюзы могут обслуживать подключения от нижестоящих IoT Edgeных устройств. Для получения дополнительных сведений переключитесь на версию [IoT Edge 1,2](?view=iotedge-2020-11&preserve-view=true) этой статьи.
...
Начиная с версии 1,2 IoT Edge, прозрачные шлюзы могут обслуживать подключения от нижестоящих IoT Edgeных устройств.
