...
2. Создайте два сертификата (основной и дополнительный) для подчиненного устройства. Простое соглашение об именовании — создание сертификатов с именем устройства IoT, а затем первичной или вторичной метки. Например:
