...
1. Найдите раздел **подготовки** файла. Раскомментируйте строки для подготовки политики диагностики с помощью сертификата X. 509 и убедитесь, что все остальные строки подготовки снабжены комментариями.
