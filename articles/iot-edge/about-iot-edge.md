...
* [Развертывание модулей на устройстве IoT Edge в Linux](quickstart-linux.md)
* [Развертывание модулей на устройстве IoT Edge в Windows](quickstart.md)
...
[Развертывание модулей на устройстве IoT Edge](quickstart-linux.md)
