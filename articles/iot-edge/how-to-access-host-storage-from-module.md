...
1. Как для IoT Edge концентратора, так и для IoT Edge агента добавьте привязки, чтобы подключить локальный каталог на хост-компьютере к каталогу в модуле. Например:
...
Кроме того, локальное хранилище можно настроить непосредственно в манифесте развертывания. Например:
