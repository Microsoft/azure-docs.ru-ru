...
1. Перед настройкой целевого объекта убедитесь, что вы добавили [корневой сертификат Baltimore в среду Java Стриим](/bingmaps/articles/ssl-certificate-validation-for-java-applications#configuring-root-certificates).
