...
> [!NOTE]
> Если вы попытаетесь добавить политику индексирования с **BoundingBox** в контейнер с `geography` типом данных, произойдет сбой.  `geometry` Перед добавлением **BoundingBox** необходимо изменить жеоспатиалконфиг контейнера. Вы можете добавить данные и изменить оставшуюся часть политики индексирования (например, пути и типы) до или после выбора геопространственного типа данных для контейнера.
