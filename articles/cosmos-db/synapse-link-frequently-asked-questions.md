...
### <a name="can-i-use-customer-managed-keys-with-the-azure-cosmos-db-analytical-store"></a>Можно ли использовать управляемые клиентом ключи с Azure Cosmos DBным аналитическим хранилищем?
