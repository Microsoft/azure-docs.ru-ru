...
- [Включение журналов диагностики для Azure Cosmos DB](./monitor-cosmos-db.md)
...
- [Включение параметров диагностики для Azure Cosmos DB](./monitor-cosmos-db.md)
...
- [Список оповещений системы защиты от угроз для Azure Cosmos DB](../security-center/alerts-reference.md#alerts-azurecosmos)
...
- [Создание собственных пользовательских ролей с помощью действий Azure Cosmos DB (Microsoft.Docпространство имен Ументдб)](../role-based-access-control/resource-provider-operations.md#microsoftdocumentdb)
...
- [Повторное создание ключей Azure Cosmos DB](./manage-with-powershell.md#regenerate-keys)
...
- [Индексирование Azure Cosmos DB данных с помощью Когнитивный поиск Azure](../search/search-howto-index-cosmosdb.md?bc=%2fazure%2fcosmos-db%2fbreadcrumb%2ftoc.json&toc=%2fazure%2fcosmos-db%2ftoc.json)
...
- [Основные сведения об управлении ключами для шифрования неактивных данными с помощью Azure Cosmos DB]()
...
- [Поддерживаемые функции доступны в Центре безопасности Azure](../security-center/security-center-services.md?tabs=features-windows)
...
- [Какие Azure Cosmos DB ресурсы поддерживают Теги](../azure-resource-manager/management/tag-support.md#microsoftdocumentdb)
...
- [Восстановление данных в Azure Cosmos DB](./online-backup-and-restore.md)
...
- [Восстановление секретов Azure Key Vault](/powershell/module/az.keyvault/restore-azkeyvaultkey?preserve-view=true&view=azps-4.8.0)
