...
| Варианты |Выберите пункт **Параметры**, чтобы изменить значок консоли, указать режимы доступа и разрешения пользователя или удалить файлы консоли для увеличения доступного дискового пространства. |
...
|  |С |Открывает страницу **Параметры**. | |
...
|  |C |Обновление консоли диспетчера моментальных снимков StorSimple. | |
