...
| Создать политику архивации |Используйте один из следующих вариантов:<ul><li>Щелкните правой кнопкой мыши пункт **Политики резервного копирования**.</li><li>Щелкните узел **Группы томов** или разверните его, а затем щелкните правой кнопкой мыши группу томов.</li><li>Щелкните узел **Каталог резервных копий** или разверните его, а затем щелкните правой кнопкой мыши группу томов.</li></ul> |Выберите пункт **Создать политику резервного копирования**, чтобы настроить резервное копирование по расписанию для группы томов. |
| Создать группу томов |Используйте один из следующих вариантов:<ul><li>Щелкните узел **Тома**, а затем щелкните правой кнопкой мыши том в панели **Результаты**.</li><li>Щелкните правой кнопкой мыши узел **Группы томов**.</li></ul> |Выберите пункт **Создать группу томов**, чтобы назначить тома в группу томов. |
...
| Help |Щелкните любой узел или результат. (Этот элемент появляется во всех вариантах меню **Действие** и панелей **Действия**.) |Выберите пункт **Справка**, чтобы открыть справку в Интернете в отдельном окне браузера. |
...
| Создать резервную копию |Используйте один из следующих вариантов:<ul><li>Разверните узел **Группы томов** и щелкните правой кнопкой мыши группу томов.</li><li>Разверните узел **Каталог резервных копий** и щелкните правой кнопкой мыши группу томов.</li></ul> |Выберите пункт **Take Backup** (Выполнить резервное копирование), чтобы немедленно запустить задание резервного копирования. |
...
| Элемент меню | Описание |
|:--- |:--- |
| Добавление в избранное |Выберите пункт **Добавить в избранное**, чтобы добавить текущее представление в список избранного. |
...
| ВВОД |Нажмите клавишу ВВОД, чтобы завершить действие и перейти к следующему шагу. Например, можно нажать клавишу Ввод, чтоб выбрать **Далее**, **OK** или **Создать**, а затем перейти к следующему шагу мастера. |
...
|  |A |Открывает страницу **Сохранить как**. | |
...
|  |H |Открытие справки в Интернете. | |
| ALT+V |Открывает меню **Представление**. |A |Открывает страницу **Добавить/ удалить столбцы**. |
|  |U |Открывает страницу **Настройка представления**. | |
| ALT+O |Открывает меню **Избранное**. |A |Открывает страницу **Добавить/ удалить избранное**. |
...
|  |A |Открывает странице **Сведения о консоли управления Microsoft**. | |
