...
4. В колонке **добавления учетной записи хранения** выполните следующие действия.
    ...
    4. Чтобы включить TLS, нажмите кнопку **Enable (включить** ), чтобы создать безопасный канал для сетевого взаимодействия между вашей службой StorSimple Диспетчер устройств и облаком. Если используется частное облако, выберите параметр **Отключить**.
