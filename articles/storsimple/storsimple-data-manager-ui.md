...
10. После добавления репозитория данных подождите несколько минут.
    ...
    2. Выберите тип хранилища больших двоичных объектов или файлов. Укажите имя контейнера хранилища, в котором хранятся преобразованные данные. Нажмите кнопку **OK**.
