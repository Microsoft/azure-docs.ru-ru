...
| База данных |SQL-код |Да* |Поддерживается только для локально закрепленных томов. |Обновление 2 и более поздняя версия |
...
| Сценарий | Рабочая нагрузка | Поддерживается | Ограничения | Версия |
| --- | --- | --- | --- | --- |
| Общие |ExpressRoute |Да | |Все версии |
| Общие |DataCore FC |Да* |Поддерживается DataCore SANsymphony. |Все версии |
| Общие |DFSR |Да* |Поддерживается только для локально закрепленных томов. |Все версии |
| Общие |Индексация |Да* |Для многоуровневых томов поддерживается только индексирование метаданных (не данных).<br>Для локально закрепленных томов поддерживается полное индексирование. |Все версии |
| Общие |Антивирусные программы |Да* |Для многоуровневых томов поддерживается только проверка при открытии и закрытии.<br>  Для локально закрепленных томов поддерживается полная проверка. |Все версии |
