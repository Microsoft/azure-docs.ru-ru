...
Описанные обходные решения для VMware будут реализованы вместо установки соответствующего исправления до тех пор, пока не будут развернуты следующие запланированные обновления. 
