...
Функция обратимого удаления доступна через [REST API](/rest/api/keyvault/), [Azure CLI](./key-vault-recovery.md), [Azure PowerShell](./key-vault-recovery.md)и интерфейсы [.NET/C#](/dotnet/api/microsoft.azure.keyvault) , а также [шаблоны ARM](/azure/templates/microsoft.keyvault/2019-09-01/vaults).
