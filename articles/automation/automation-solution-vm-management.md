...
> [!NOTE]
> Перед установкой этой версии мы хотели бы узнать о [следующей версии](https://github.com/microsoft/startstopv2-deployments), которая прямо сейчас доступна в предварительном просмотре.  Эта новая версия (v2) предлагает те же функции, что и эта, но она разработана для использования преимуществ новых технологий в Azure. Он добавляет некоторые из часто запрашиваемых функций от клиентов, таких как поддержка нескольких подписок, из одного экземпляра запуска или окончания.
