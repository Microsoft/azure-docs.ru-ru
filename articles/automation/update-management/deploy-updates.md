...
> [!IMPORTANT]
> Создав развертывание обновлений, вы принимаете условия лицензионного соглашения на использование программного обеспечения (EULA), предоставляемые компанией для обновления операционной системы.
