...
A. Диск Data Box поддерживается для всех регионов в США, Канаде, ЕС, Великобритании, Австралии, Сингапур, Индии, Китае, Гонконг, Японии, Корее и Южной Африки. Поддерживаются регионы только общедоступного облака Azure. Облако Azure для государственных организаций и другие национальные облака не поддерживаются.
...
A.  Нет. В настоящее время с дисками Data Box можно использовать только одну учетную запись хранения (общая или классическая). Поддерживаются и "горячие", и "холодные" большие двоичные объекты.
