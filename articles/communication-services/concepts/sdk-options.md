...
ms.locfileid: "105562449"
---
# <a name="sdks-and-rest-apis"></a>Пакеты SDK и интерфейсы REST API

Возможности служб связи Azure концептуально организованы в шесть областей. Большинство областей имеют полностью открытые клиентские библиотеки с открытым кодом, запрограммированные на основе опубликованных API-интерфейсов RESTFUL, которые можно использовать непосредственно через Интернет. Вызывающая клиентская библиотека использует частные сетевые интерфейсы и в настоящее время закрыто источником. Примеры и дополнительные технические сведения для пакетов SDK публикуются в [репозитории GitHub служб связи Azure](https://github.com/Azure/communication).
...
| Распространенные | Azure. Communication. Common| REST | Предоставляет базовые типы для других клиентских библиотек |
...
| [Приобрести план телефонного номера](https://docs.microsoft.com/rest/api/communication/phonenumberadministration/purchasesearch) | 1 запрос в день       |
