...
Сеть клиента обычно имеет несколько периметров сети с брандмауэрами и/или прокси-серверами, обеспечивающими выполнение политик безопасности вашей организации. Мы рекомендуем выполнить [комплексную оценку сети](/microsoftteams/3-envision-evaluate-my-environment), чтобы гарантировать оптимальные производительность и качество решения по коммуникации.
...
:::image type="content" source="./media/call-flows/vpn-to-internal-direct-media.png" alt-text="Схема: поток индивидуальных вызовов (внутренний пользователь) при использовании VPN с прямой передачей данных.":::
...
:::image type="content" source="./media/call-flows/vpn-user-to-external-user.png" alt-text="Схема: поток индивидуальных вызовов (внешний пользователь) при использовании VPN с прямой передачей данных.":::
