...
1. Внешние пользователи могут использовать ваше пользовательское приложение, чтобы принять участие в конференции Teams (с использованием пакетов SDK вызовов и чатов Служб коммуникации).
...
Пользователи Служб коммуникации могут присоединяться к конференциям по расписанию, если в [параметрах конференций](/microsoftteams/meeting-settings-in-teams) включены анонимные подключения. Если собрание запланировано для канала, пользователи Служб коммуникации не смогут присоединяться к чату или отправлять и получать сообщения.
