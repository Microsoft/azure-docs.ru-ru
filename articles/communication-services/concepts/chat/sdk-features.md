...
|Сигнализация в реальном времени (включено собственным пакетом сигнализации**)| Получение уведомления при получении пользователем нового сообщения беседы в чате, членом которой он является                                     | ✔️   | ❌    | ❌  | ❌  |
