...
|Сигнализация в реальном времени (включено защищаемым пакетом сигнализации**)| Получение уведомления при получении пользователем нового сообщения беседы в чате, членом которой он является                                     | ✔️   | ❌    | ❌  | ❌  |
