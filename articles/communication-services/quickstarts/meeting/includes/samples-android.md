---
title: Внедрение команд служб взаимодействия Azure для Android
description: В этом обзоре вы узнаете, как использовать библиотеку команд служб связи Azure для Android.
author: palatter
ms.author: palatter
ms.date: 24/02/2021
ms.topic: conceptual
...
Добавьте в `MeetingEventListener` класс.
...
Установите `MeetingEventListener` в `this` .
...
Реализуйте `onCallStateChanged` `onRemoteParticipantCountChanged` методы и.
...
Добавьте в `MeetingIdentityProvider` класс.
...
Установите `MeetingIdentityProvider` в `this` .
