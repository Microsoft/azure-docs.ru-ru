...
[Закрепленные виртуальные машины зоны Azure](../virtual-machines/windows/create-portal-availability-zone.md) можно восстановить в любой [зоне доступности](../availability-zones/az-overview.md) одного региона.

В процессе восстановления вы увидите параметр **Зона доступности.** Сначала вы увидите свою зону по умолчанию. Чтобы выбрать другую зону, выберите нужный вариант. Если закрепленная зона недоступна, вы не сможете восстановить данные в другую зону, так как резервные копии данных не зоналли реплицированы. Восстановление в зонах доступности возможно только в точках восстановления на уровне хранилища.
...
- Если вы используете дистрибутив Linux на основе cloud-init (например, Ubuntu), то в целях безопасности пароль будет заблокирован после восстановления. Чтобы [сбросить пароль](/troubleshoot/azure/virtual-machines/reset-password), на восстановленной виртуальной машине рекомендуется использовать расширение VMAccess. Мы советуем использовать ключи SSH в этих дистрибутивах, чтобы не сбрасывать пароль после восстановления.
- Если вы не можете получить доступ к виртуальной машине после восстановления из-за неработающего отношения виртуальной машины с контроллером домена, выполните следующие действия, чтобы открыть ВИРТУАЛЬную машину.
  ...
  - Установите агент ВМ вручную, если агент Azure не отвечает, по следующей [ссылке](/troubleshoot/azure/virtual-machines/install-vm-agent-offline).
