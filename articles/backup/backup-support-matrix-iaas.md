...
Резервное копирование виртуальных машин Azure под управлением Linux с помощью точек подключения DOCKER | В настоящее время Azure Backup не поддерживает исключение точек подключения DOCKER, так как они подключены к разным путям каждый раз.
...
Восстановление файлов с общего диска, с временного диска, с дублированного диска, с помощью быстрого доступа к диску и диску с включенным ускорителем записи | Восстановление не поддерживается, <br/><br/>см. раздел [Поддержка хранилища виртуальных машин Azure](#vm-storage-support).
...
[Выделенный узел Azure](../virtual-machines/dedicated-hosts.md) | Поддерживается
...
[Временные диски](../virtual-machines/managed-disks-overview.md#temporary-disk) | Резервное копирование временных дисков не производится Azure Backup.
NVMe и временные диски | Не поддерживается.
