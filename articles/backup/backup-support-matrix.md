...
**Частные конечные точки** | В [этом разделе](./private-endpoints.md#before-you-start) приведены требования к созданию частных конечных точек для хранилища службы восстановления.  
...
| ---------------------- | ------------------------------------------------------------ | ----------------- |
| Azure               | Поддерживается для виртуальных машин Azure с управляемыми и неуправляемыми дисками. Не поддерживается для классических виртуальных машин. | Доступно во всех общедоступных регионах Azure и регионах независимых, за исключением центрального Франции, Центральной Австралии, Южно-Африканского региона, Севера для ОАЭ, Северная Швейцария, Центрально-Западная Германия, Восточная норвежской. <br>Для получения сведений об использовании в этих регионах обратитесь к [AskAzureBackupTeam@microsoft.com](mailto:AskAzureBackupTeam@microsoft.com) |
| SQL или SAP HANA | В предварительной версии                                                      | Доступно во всех общедоступных регионах Azure и регионах независимых, за исключением центрального Франции, Центральной Австралии, Южно-Африканского региона, Севера для ОАЭ, Северная Швейцария, Центрально-Западная Германия, Восточная норвежской. <br>Для получения сведений об использовании в этих регионах обратитесь к [AskAzureBackupTeam@microsoft.com](mailto:AskAzureBackupTeam@microsoft.com) |
