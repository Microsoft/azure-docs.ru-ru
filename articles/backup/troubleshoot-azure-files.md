...
В портал Azure откройте   >  **инфраструктуру резервного копирования** хранилища  >  **учетные записи хранения**. Выберите отменить **регистрацию** , чтобы удалить учетные записи хранения из хранилища служб восстановления.
...
Используйте другую целевую общую папку. Кроме того, вы можете отменить задачу или дождаться завершения другого восстановления.
