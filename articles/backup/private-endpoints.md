...
- Виртуальные сети с политиками сети не поддерживаются для частных конечных точек. Прежде чем продолжить, необходимо [Отключить политики сети](../private-link/disable-private-endpoint-network-policy.md) .
...
Сведения об удалении частных конечных точек см. в [этом разделе](/rest/api/virtualnetwork/privateendpoints/delete) .
