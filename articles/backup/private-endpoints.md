...
- Виртуальные сети с политиками сети не поддерживаются для частных конечных точек. Прежде чем продолжить, необходимо [Отключить политики сети](https://docs.microsoft.com/azure/private-link/disable-private-endpoint-network-policy) .
...
## <a name="deleting-private-endpoints"></a>Удаление частных конечных точек

Сведения об удалении частных конечных точек см. в [этом разделе](https://docs.microsoft.com/rest/api/virtualnetwork/privateendpoints/delete) .
