...
1. Если восстанавливаемый диск шифруется с помощью [ключей, управляемых клиентом (CMK)](../virtual-machines/disks-enable-customer-managed-keys-portal.md) , или с помощью [двойного шифрования с использованием ключей, управляемых платформой, и ключей, управляемых клиентом](../virtual-machines/disks-enable-double-encryption-at-rest-portal.md), назначьте разрешение **читатель** для управляемого удостоверения хранилища архивации на ресурсе **набора шифрования диска** .
