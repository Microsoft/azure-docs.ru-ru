...
1. Подключитесь к Azure с помощью командлета [Connect-азаккаунт](/powershell/module/az.accounts/connect-azaccount) .
...
Интегрированное восстановление состоит из двух этапов. Первый шаг состоит в восстановлении точек восстановления, хранящихся в архиве, и временном хранении их на уровне "Стандартный" хранилища (также известной как длительность восстановления) от периода от 10 до 30 дней. Значение по умолчанию — 15 дней. Существует два разных приоритета — "Стандартный" и "высокий". Дополнительные сведения о [приоритете rehydratи](../storage/blobs/storage-blob-rehydration.md#rehydrate-an-archived-blob-to-an-online-tier).
