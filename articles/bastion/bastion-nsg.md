...
> [!IMPORTANT]
> Если вы решили использовать NSG с ресурсом Azure бастиона, **необходимо** создать все правила входящего и исходящего трафика. Пропуск любого из следующих правил в NSG приведет к блокировке ресурса бастиона Azure от получения необходимых обновлений в будущем и последующего открытия ресурса для будущих уязвимостей системы безопасности.
> 
