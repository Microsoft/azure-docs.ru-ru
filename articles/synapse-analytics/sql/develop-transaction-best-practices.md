...
Дополнительные сведения об уровнях изоляции и ограничениях транзакций см. [в разделе транзакции в выделенном пуле SQL](develop-transactions.md) .  Общие сведения о других рекомендациях см. в разделе рекомендации по [выделению пула SQL](best-practices-dedicated-sql-pool.md).
