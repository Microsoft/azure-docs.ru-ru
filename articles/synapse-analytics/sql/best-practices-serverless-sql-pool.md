...
## <a name="client-applications-and-network-connections"></a>Клиентские приложения и сетевые подключения

Убедитесь, что клиентское приложение подключено к ближайшей возможной рабочей области синапсе с оптимальным подключением.
- Совместное размещение клиентского приложения с рабочей областью синапсе. Если вы используете такие приложения, как Power BI или Azure Analysis Service, убедитесь, что они находятся в том же регионе, в котором вы поместили рабочую область синапсе. При необходимости создайте отдельные рабочие области, связанные с клиентскими приложениями. Размещение клиентского приложения и рабочей области синапсе в другом регионе может привести к увеличению задержки и более медленной потоковой передаче результатов.
- При чтении данных из локального приложения убедитесь, что Рабочая область синапсе находится в регионе, близком к Вашему расположению.
- Убедитесь, что у вас нет проблем с пропускной способностью сети при чтении большого объема данных.
- Не используйте синапсе Studio для возврата большого объема данных. Синапсе Studio — это веб-инструмент, использующий протокол HTTPS для перемещения данных. Для чтения большого объема данных используйте Azure Data Studio или SQL Server Management Studio.
...
### <a name="colocate-your-cosmosdb-analytical-storage-and-serverless-sql-pool"></a>Совместное размещение аналитического хранилища CosmosDB и бессерверного пула SQL

Убедитесь, что хранилище CosmosDB аналитики размещено в том же регионе, что и Рабочая область синапсе. Запросы между регионами могут вызвать большие задержки.
