...
Метрика 2: *распределение группы рабочей нагрузки по проценту ресурсов закрепления* (среднее агрегирование, `purple line` )<br>
