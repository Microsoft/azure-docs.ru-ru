...
В этой статье перечислены ресурсы по пространству имен поставщиков ресурсов. Список поставщиков ресурсов для служб Azure см. в статье [Поставщики ресурсов для служб Azure](azure-services-resource-providers.md).

В именах ресурсов не учитывается регистр, кроме случаев, указанных в столбце допустимых символов.
...
> | Сущность | Область | Длина | Допустимые символы |
> | --- | --- | --- | --- |
> | automationAccounts | группа ресурсов и регион <br>(см. примечание ниже) | 6–50 | Буквенно-цифровые символы и дефисы.<br><br>Начинается с буквы и заканчивается буквенно-цифровым символом. |
...
> | galleries / images | gallery | От 1 до 80 | Буквенно-цифровые символы, символы подчеркивания, дефисы и точки.<br><br>Начинается и закачивается буквенно-цифровым символом. |
...
> | virtualMachines | resource group | 1–15 (Windows)<br>1–64 (Linux)<br><br>См. примечание ниже. | Нельзя использовать пробелы или следующие символы:<br> `\/"'[]:|<>+=;,?*@&_`<br><br>Виртуальные машины Windows не могут включать точку или заканчиваться дефисом.<br><br>Виртуальные машины Linux не может заканчиваться точкой или дефисом. |
> | virtualMachineScaleSets | resource group | 1–15 (Windows)<br>1–64 (Linux)<br><br>См. примечание ниже. | Нельзя использовать пробелы или следующие символы:<br> `\/"'[]:|<>+=;,?*@&`<br><br>Не может начинаться с символа подчеркивания. Не может заканчиваться точкой или дефисом. |
...
> | scheduledQueryRules | resource group | 1–260 | Нельзя использовать:<br>`*<>%{}&:\\?/#` <br><br>Не может заканчиваться пробелом или точкой.  |
> | metricAlerts | resource group | 1–260 | Нельзя использовать:<br>`*#&+:<>?@%{}\/` <br><br>Не может заканчиваться пробелом или точкой.  |
> | activityLogAlerts | resource group | 1–260 | Нельзя использовать:<br>`<>*%{}&:\\?+/#` <br><br>Не может заканчиваться пробелом или точкой.  |
...
> | templateSpecs | resource group | 1–90 | Буквенно-цифровые символы, символы подчеркивания, круглые скобки, дефисы и точки. |
...
> | sites | глобально или на домен. См. примечание ниже. | 2–60 | Содержит буквенно-цифровые символы и дефисы.<br><br>Не может начинаться или заканчиваться дефисом. |
> | sites / slots | site | 2–59 | Буквенно-цифровые символы и дефисы. |

> [!NOTE]
> Веб-сайт должен иметь глобальный уникальный URL-адрес. При создании веб-сайта, использующего план размещения, URL-адрес имеет значение `http://<app-name>.azurewebsites.net`. Имя приложения должно быть глобально уникальным. При создании веб-сайта, использующего Среду службы приложений, имя приложения должно быть уникальным в пределах [домена Среды службы приложений](../../app-service/environment/using-an-ase.md#app-access). В обоих случаях URL-адрес сайта является глобально уникальным.
>
