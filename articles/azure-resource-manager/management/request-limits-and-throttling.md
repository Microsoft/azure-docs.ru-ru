...
Сведения об ограничениях регулирования для операций вычислений см. в разделе [Устранение ошибок регулирования API — вычисление](/troubleshoot/azure/virtual-machines/troubleshooting-throttling-errors).
...
Поставщик ресурсов также может возвращать заголовки ответа со сведениями о оставшихся запросах. Дополнительные сведения о заголовках ответов, возвращаемых поставщиком ресурсов вычислений, см. в разделе " [Частота вызовов](/troubleshoot/azure/virtual-machines/troubleshooting-throttling-errors#call-rate-informational-response-headers)".
