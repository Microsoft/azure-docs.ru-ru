...
| область | Нет | Свойство Scope доступно только для [типов ресурсов расширения](../management/extension-resource-types.md). Используйте его при указании области, отличной от области развертывания. См. раздел [Настройка области для ресурсов расширения в шаблонах ARM](scope-extension-resources.md). |
