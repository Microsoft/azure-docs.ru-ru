...
1. Выберите **Скачать**.  Скачанный ZIP-файл содержит файл **template.json** и **parameters.json**. Распакуйте файлы.
