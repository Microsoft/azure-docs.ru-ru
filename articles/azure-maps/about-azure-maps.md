...
### <a name="weather-services"></a>Службы погоды
...
Разработчики могут использовать [API получения погоды по маршруту](/rest/api/maps/weather/getweatheralongroute) для получения сведений о погоде по определенному маршруту. Кроме того, служба поддерживает генерацию уведомлений о погоде для точек маршрута, для которых существует вероятность опасных погодных явлений, таких как наводнение и сильный ливень.
