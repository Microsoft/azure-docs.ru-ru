...
На следующем снимке экрана показан приведенный выше код, отображающий данные о трафике в режиме реального времени на карте.
...
На следующем снимке экрана показан приведенный выше код для отображения сведений о трафике в режиме реального времени на карте с всплывающим сообщением, отображающим сведения об инциденте.
