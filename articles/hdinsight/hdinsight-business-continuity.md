...
|Возможность подключения |Требуется, чтобы все вышестоящее и подчиненные системы из основного сервера подключались к базе данных-получателю.|Ограничьте вторичное подключение до исходного минимального подмножества.|
