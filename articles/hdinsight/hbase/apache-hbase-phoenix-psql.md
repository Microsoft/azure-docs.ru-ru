...
:::image type="content" source="./media/apache-hbase-phoenix-psql/apache-ambari-phoenix.png" alt-text="Параметры кластера HDInsight для Apache Phoenix" border="true":::
