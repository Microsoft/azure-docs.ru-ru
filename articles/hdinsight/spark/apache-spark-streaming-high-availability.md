...
:::image type="content" source="./media/apache-spark-streaming-high-availability/apache-spark-streaming.png" alt-text="Потоковая передача Spark" border="false":::
...
:::image type="content" source="./media/apache-spark-streaming-high-availability/apache-spark-dstream.png" alt-text="Поток DStream Spark" border="false":::
...
:::image type="content" source="./media/apache-spark-streaming-high-availability/structured-streaming.png" alt-text="Структурированная потоковая передача Spark" border="false":::
...
:::image type="content" source="./media/apache-spark-streaming-high-availability/hdi-yarn-architecture.png" alt-text="Архитектура YARN" border="false":::
