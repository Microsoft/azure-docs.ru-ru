...
1. В меню сверху выберите **+ Create a resource** (+ Создать ресурс).
    ...
    :::image type="content" source="./media/apache-spark-jupyter-spark-sql-use-portal/azure-portal-create-resource.png " alt-text="Создание ресурса на портале Azure" border="true":::
...
1. На вкладке **Основные сведения** укажите следующую информацию:
    ...
    :::image type="content" source="./media/apache-spark-jupyter-spark-sql-use-portal/azure-portal-cluster-basics-spark.png " alt-text="Снимок экрана: страница &quot;Создание кластера HD Insight&quot; с выбранной вкладкой &quot;Базовые&quot;." border="true":::
...
1. На странице **Хранилище** укажите следующие значения.
    ...
    :::image type="content" source="./media/apache-spark-jupyter-spark-sql-use-portal/azure-portal-cluster-storage.png " alt-text="Снимок экрана: страница &quot;Создание кластера HD Insight&quot; с выбранной вкладкой &quot;Хранилище&quot;." border="true":::
...
1. Щелкните **Создать** > **PySpark**, чтобы создать элемент Notebook.
   ...
   :::image type="content" source="./media/apache-spark-jupyter-spark-sql-use-portal/hdinsight-spark-create-jupyter-interactive-spark-sql-query.png " alt-text="Создание Jupyter Notebook для выполнения интерактивного SQL-запроса Spark" border="true":::
...
1. Убедитесь, что ядро готово. Ядро будет готово, когда в записной книжке появится пустой круг рядом с именем ядра. Заполненный круг означает, что ядро занято.
    ...
    :::image type="content" source="./media/apache-spark-jupyter-spark-sql/jupyter-spark-kernel-status.png " alt-text="Снимок экрана: окно Jupyter с индикатором PySpark." border="true"::: border="true":::
...
1. Вставьте указанный ниже код в пустую ячейку и нажмите сочетание клавиш **SHIFT + ВВОД**, чтобы выполнить код. Эта команда выводит список таблиц Hive в кластере:
    ...
    :::image type="content" source="./media/apache-spark-jupyter-spark-sql-use-portal/hdinsight-spark-get-started-hive-query.png " alt-text="Снимок экрана: окно Jupyter для записной книжки, созданной при работе с этим кратким руководством." border="true"::: border="true":::
...
1. Выполните другой запрос, чтобы вывести данные из таблицы `hivesampletable`.
    ...
    :::image type="content" source="./media/apache-spark-jupyter-spark-sql-use-portal/hdinsight-spark-get-started-hive-query-output.png " alt-text="Выходные данные запроса Hive в HDInsight" border="true":::
...
:::image type="content" source="./media/apache-spark-jupyter-spark-sql-use-portal/hdinsight-azure-portal-delete-cluster.png " alt-text="Удаление кластера HDInsight на портале Azure" border="true":::
