...
:::image type="content" source="./media/use-pig/hdi-data-transformation.gif" alt-text="Графическое представление преобразований" border="false":::
