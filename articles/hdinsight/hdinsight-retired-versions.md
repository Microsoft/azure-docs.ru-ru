---
title: Устаревшие версии Azure HDInsight
description: Сведения о прекращенных версиях в Azure HDInsight.
...
ms.locfileid: "103490251"
---
# <a name="retired-hdinsight-versions"></a>Устаревшие версии HDInsight

В этой статье вы узнаете о прекращении использования версий в HDInsight.

## <a name="retired-version-list"></a>Список версий, снятых с учета

В следующей таблице перечислены отмененные версии HDInsight.
...
- [Поддерживаемые компоненты и версии Apache в HDInsight](./hdinsight-component-versioning.md)
