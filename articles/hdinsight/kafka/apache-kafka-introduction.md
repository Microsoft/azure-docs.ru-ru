...
:::image type="content" source="./media/apache-kafka-introduction/kafka-cluster-diagram.png" alt-text="Схема конфигурации кластера Kafka" border="false":::
