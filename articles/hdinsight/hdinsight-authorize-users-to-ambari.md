...
:::image type="content" source="./media/hdinsight-authorize-users-to-ambari/manage-apache-ambari.png" alt-text="Управление панелью Apache Ambari":::
...
1. На странице Управление выберите **Пользователи**.
    ...
    :::image type="content" source="./media/hdinsight-authorize-users-to-ambari/apache-ambari-management-page-users.png" alt-text="Пользователи страницы управления Apache Ambari":::
...
1. На странице управления щелкните ссылку **Views** (Представления) под заголовком меню **Views** (Представления) в левой части экрана.
    ...
    :::image type="content" source="./media/hdinsight-authorize-users-to-ambari/apache-ambari-views-link.png" alt-text="Ссылки представления представлений Apache Ambari":::
...
2. На странице "Views" (Представления) разверните строку **HIVE**. При добавлении службы Hive в кластер создается представление по умолчанию Hive. При необходимости можно также создать дополнительные экземпляры представлений Hive. Выберите представление Hive.
    ...
    :::image type="content" source="./media/hdinsight-authorize-users-to-ambari/views-apache-hive-view.png" alt-text="Представления HDInsight — представление Apache Hive":::
...
**Grant permission to these users** :::image type="content" source="./media/hdinsight-authorize-users-to-ambari/hdi-add-user-to-view.png" alt-text="Grant permission to these users"::: (Предоставить разрешение данным пользователям)

**Grant permission to these groups** :::image type="content" source="./media/hdinsight-authorize-users-to-ambari/add-group-to-view-permission.png" alt-text="Grant permission to these groups"::: (Предоставить разрешение данным группам)
...
1. Чтобы добавить пользователя, нажмите кнопку **Add User** (Добавить пользователя).
   ...
   * Начните вводить имя пользователя, и вы увидите раскрывающийся список ранее определенных имен.
     ...
     :::image type="content" source="./media/hdinsight-authorize-users-to-ambari/ambari-user-autocomplete.png" alt-text="Автоматическое завершение пользователем Apache Ambari":::
   ...
   * Чтобы сохранить изменения, щелкните **синий флажок**.
     ...
     :::image type="content" source="./media/hdinsight-authorize-users-to-ambari/user-entered-permissions.png" alt-text="Разрешения пользователя для Apache Ambari Grant":::
...
1. Чтобы добавить группу, нажмите кнопку **Add Group** (Добавить группу).
   ...
   * Чтобы сохранить изменения, щелкните **синий флажок**.
     ...
     :::image type="content" source="./media/hdinsight-authorize-users-to-ambari/ambari-group-entered.png" alt-text="Разрешения на предоставление доступа Apache Ambari":::
...
:::image type="content" source="./media/hdinsight-authorize-users-to-ambari/views-apache-tez-view.png" alt-text="Представления HDInsight — представление Apache Tez":::
...
:::image type="content" source="./media/hdinsight-authorize-users-to-ambari/cluster-roles-menu-link.png" alt-text="Ссылки меню ролей Apache Ambari":::
...
:::image type="content" source="./media/hdinsight-authorize-users-to-ambari/roles-menu-permissions.png" alt-text="Меню &quot;роли&quot; Apache Ambari. Связывание разрешений":::
...
:::image type="content" source="./media/hdinsight-authorize-users-to-ambari/ambari-roles-block-view.png" alt-text="Представление блокировки ролей Apache Ambari":::
...
* В категории "Users" (Пользователи) представления "List" (Список) отображается список всех пользователей, в котором из раскрывающегося списка можно выбрать роль для каждого пользователя.
    ...
    :::image type="content" source="./media/hdinsight-authorize-users-to-ambari/roles-list-view-users.png" alt-text="Представление списка ролей Apache Ambari — пользователи":::
...
* Категория "Groups" (Группы) представления "List" (Список) содержит все группы, а также роли, назначенные каждой группе. В нашем примере список групп синхронизирован с группами Azure AD, указанными в свойстве **Access user group** (Группа доступа пользователей) параметров домена кластера. См. [Создание кластера HDInsight с корпоративным пакетом безопасности](./domain-joined/apache-domain-joined-configure-using-azure-adds.md#create-an-hdinsight-cluster-with-esp).
    ...
    :::image type="content" source="./media/hdinsight-authorize-users-to-ambari/roles-list-view-groups.png" alt-text="Представление списка ролей Apache Ambari — группы":::
...
:::image type="content" source="./media/hdinsight-authorize-users-to-ambari/ambari-user-views-only.png" alt-text="Пользователь Apache Ambari с только представлениями":::
...
:::image type="content" source="./media/hdinsight-authorize-users-to-ambari/user-cluster-user-role.png" alt-text="Отображение панели мониторинга Apache Ambari":::
