...
<li><a href="/cli/azure/webapp?view=azure-cli-latest#az-webapp-create">Создайте <abbr title="Представление веб-приложения, которое содержит код приложения, имена узлов DNS, сертификаты и связанные ресурсы. ">приложение Службы приложений Azure</abbr></a> с указанным именем.</li>
</ul>
</details>
