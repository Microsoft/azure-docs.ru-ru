...
ASE выделяется исключительно для одной подписки и может размещать в 200 общее количество экземпляров плана службы приложений в нескольких планах службы приложений. Слово «экземпляр» относится к горизонтальному масштабированию плана службы приложений. Каждый экземпляр является эквивалентом рабочей роли. Хотя ASE может иметь 200 экземпляров, в одном изолированном плане службы приложений версии 2 может храниться 100 экземпляров. ASE может содержать два плана службы приложений с 100 экземплярами в каждом, 200 планах службы приложений с одним экземпляром или все, что находится между ними.
...
- Невозможность масштабирования плана службы приложений за пределами 50 экземпляров
