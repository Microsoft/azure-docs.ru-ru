...
**Параметры**  >  Пул внешних интерфейсов   /  **Пулы рабочих ролей**. Каждая из этих колонок пула ресурсов позволяет просматривать сведения только в этом пуле ресурсов, а также предоставлять элементы управления для полного масштабирования пула ресурсов.  
