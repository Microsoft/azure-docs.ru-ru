...
| SQL Server | `com.microsoft.sqlserver.jdbc.SQLServerDriver` | [Загрузить](/sql/connect/jdbc/download-microsoft-jdbc-driver-for-sql-server#download)                                                           |
