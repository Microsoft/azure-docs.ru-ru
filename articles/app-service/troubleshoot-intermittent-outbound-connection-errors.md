...
* [Управление подключениями Apache](https://hc.apache.org/httpcomponents-client-5.0.x/)
* [Класс Пулингхттпклиентконнектионманажер](https://hc.apache.org/httpcomponents-client-5.0.x/)
