...
Ответы обрабатываются параметрами запроса:
...
Несмотря на то, что этот код можно написать в собственном коде, гораздо проще использовать функции из существующей библиотеки JavaScript. В этой статье упоминается два, один для предложений и другой для автозаполнения. 
...
Используйте эти ссылки для получения комплексных инструкций или кода, демонстрирующих возможности поиска как типов. В примере демонстрируются гибридные реализации предложений и автозаполнения вместе.
