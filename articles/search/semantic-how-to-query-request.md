...
Если указано только одно поле, используйте описательное поле, в котором можно найти ответ на семантические запросы, например основное содержимое документа. Выберите поле, которое предоставляет достаточное содержимое. Чтобы обеспечить своевременную обработку, всего лишь около 8 000 маркеров общего содержимого searchFields и ранжирования проходят оценку.
