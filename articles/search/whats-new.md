...
ms.locfileid: "101694603"
---
# <a name="whats-new-in-azure-cognitive-search"></a>Новые возможности в Когнитивном поиске Azure

Узнайте о новых возможностях службы. Создайте закладку для этой страницы, чтобы получать последние сведения об обновлениях службы. Просмотрите список [предварительных версий функций](search-api-preview.md), чтобы ознакомиться с полным списком возможностей, которые пока не являются общедоступными.

## <a name="march-2021"></a>Март 2021 г.

|Функция&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  |  Описание | Доступность  |
|------------------------------|---------------|---------------|
| [Семантический поиск](semantic-search-overview.md) | Этот набор функций, связанных с запросами, улучшает релевантность результатов поиска с минимальными усилиями. Внеся небольшие изменения в запрос поиска, вы можете оценить работу этих функций на существующих индексах.</br></br>[Семантический запрос](semantic-how-to-query-request.md) — это новый тип запроса, который использует усовершенствования в обработке естественного языка для улучшения ранжирования и определения намерения запроса, чтобы предоставлять ответы, субтитры и семантическое выделение.</br></br>[Семантическое ранжирование, ответы, субтитры и выделение](semantic-how-to-query-response.md) относятся к модели, которая оценивает результаты и способность добавлять структуру к ответу. | Общедоступная предварительная версия ([по запросу](https://aka.ms/SemanticSearchPreviewSignup)). </br></br>Используйте [Поиск по документам — REST](/rest/api/searchservice/preview-api/search-documents) api-version=2020-06-30-Preview и [Проводник поиска](search-explorer.md) на портале Azure. </br></br>Применяются ограничения по региону и уровню. |
| [Проверка орфографии терминов запроса](speller-how-to-add.md) | Прежде чем термины запроса попадут в поисковую подсистему, их можно проверить на наличие орфографических ошибок. Параметр `speller` работает с любым типом запроса (простой, полный или семантический). |  Общедоступная предварительная версия, только REST, api-version=2020-06-30-Preview|
| [Индексатор SharePoint Online](search-howto-index-sharepoint-online.md) | Этот индексатор обеспечивает подключение к сайту SharePoint Online, чтобы можно было индексировать содержимое из библиотеки документов. | Общедоступная предварительная версия, только REST, api-version=2020-06-30-Preview |
...
| Сентябрь | [Расширение Visual Studio Code для Когнитивного поиска Azure](search-get-started-vs-code.md) | Добавляет рабочую область, возможности навигации, IntelliSense и шаблоны для создания индексов, индексаторов, источников данных и наборов навыков. Эта функция сейчас доступна в виде общедоступной предварительной версии.| 
