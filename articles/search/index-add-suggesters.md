...
В Azure Когнитивный поиск, typeahead или "Поиск по мере ввода", можно *включить с помощью* средства подбора. Средство подбора предоставляет список полей, которые проходят дополнительную разметку, создавая последовательности префиксов для поддержки совпадений по частичному термину. Например, средство подбора, включающее поле City со значением "Сиэтл", будет иметь сочетания префиксов "Sea", "рабочее место", "рабочее место" и "сеаттл" для поддержки typeahead.
...
+ [Создание первого приложения на C# (урок 3. Добавление поиска по мере использования)](tutorial-csharp-type-ahead-and-suggestions.md) демонстрирует предложенные запросы, автозаполнение и навигацию с несколькими аспектами. Этот код обеспечивает встроенную поддержку typeahead вместо мини-приложения.

## <a name="next-steps"></a>Дальнейшие шаги

Дополнительные сведения о запросах \ формулировку.
