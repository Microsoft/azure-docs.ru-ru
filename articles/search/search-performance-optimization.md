...
[Зоны доступности](../availability-zones/az-overview.md) разделение центров обработки данных региона на отдельные группы физического расположения для обеспечения высокой доступности в пределах одного региона. Для Когнитивный поиск отдельные реплики являются единицами для назначения зоны. Служба поиска выполняется в одном регионе; его реплики выполняются в разных зонах.
...
+ Восточная часть США (создано 27 января 2021 или более поздней версии)
