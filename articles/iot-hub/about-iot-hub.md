...
Центр Интернета вещей и пакеты SDK для устройств поддерживают соглашения [IoT Plug and Play](../iot-pnp/overview-iot-plug-and-play.md) для подключения устройств. Устройства IoT Plug and Play используют модель устройства для объявления возможностей приложениям с поддержкой IoT Plug and Play. Модель устройств позволяет разработчикам решений интегрировать интеллектуальные устройства в решения без необходимости выполнять настройку вручную.
