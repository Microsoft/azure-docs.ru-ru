...
>[!IMPORTANT]
> Чтобы успешно использовать проверку подлинности на основе удостоверений для вашей конечной точки, необходимо создать управляемое удостоверение для своего экземпляра, выполнив действия, описанные в разделе [*инструкции. Включение управляемого удостоверения для событий маршрутизации (Предварительная версия)*](./how-to-enable-managed-identities-portal.md).
