...
Ниже приведен пример текста для устройства [IoT Самонастраивающийся (PnP)](../iot-pnp/overview-iot-plug-and-play.md) с компонентами и без свойств верхнего уровня. Свойства, которые не имеют смысла для устройств (например, сообщаемых свойств), следует опустить.
