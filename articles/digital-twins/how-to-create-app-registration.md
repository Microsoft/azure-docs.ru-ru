...
:::image type="content" source="media/how-to-create-app-registration/register-an-application.png" alt-text="Представление страницы &quot;регистрация приложения&quot; с указанными введенными значениями":::
...
:::image type="content" source="media/how-to-create-app-registration/app-important-values.png" alt-text="Представление портала с важными значениями для регистрации приложения":::
...
:::image type="content" source="media/how-to-create-app-registration/add-permission.png" alt-text="Просмотр регистрации приложения в портал Azure, выделение пункта меню &quot;разрешения API&quot; и кнопка &quot;+ добавить разрешение&quot;":::
...
:::image type="content" source="media/how-to-create-app-registration/request-api-permissions-1.png" alt-text="Просмотр результатов поиска страниц &quot;разрешения API запроса&quot; с цифровым двойников Azure с ИДЕНТИФИКАТОРом приложения (клиентом) 0b07f429-9f4b-4714-9392-cc5e8e80c8b0.":::
...
> :::image type="content" source="media/how-to-create-app-registration/request-api-permissions-1-smart-spaces.png" alt-text="Просмотр результатов поиска страниц &quot;разрешения API запроса&quot; с отображением службы &quot;смарт-модули Azure&quot;":::
...
:::image type="content" source="media/how-to-create-app-registration/request-api-permissions-2.png" alt-text="Просмотр страницы &quot;разрешения API запросов&quot; Выбор разрешений &quot;чтение. запись&quot; для API-интерфейсов цифрового двойников Azure":::
...
:::image type="content" source="media/how-to-create-app-registration/verify-api-permissions.png" alt-text="Представление портала с разрешениями API для регистрации приложения Azure AD с доступом &quot;чтение и запись&quot; для Azure Digital двойников":::
...
Возможно, ваша организация требует от владельцев или администраторов Подписки дополнительных действий для успешной настройки регистрации приложения. Необходимые действия могут отличаться в зависимости от конкретных настроек в вашей организации.

Приведем некоторые распространенные действия, которые могут потребоваться от владельца/администратора подписки. Эти и другие операции можно выполнить на странице [*регистрации Azure AD App*](https://portal.azure.com/#blade/Microsoft_AAD_IAM/ActiveDirectoryMenuBlade/RegisteredApps) в портал Azure.
* Предоставление согласия администратора на регистрацию приложения. Возможно, для вашей организации требуется глобально включить *согласие администратора* в Azure AD для всех регистраций приложений в вашей подписке. Если да, владельцу или администратору потребуется нажать эту кнопку для вашей компании на странице *разрешений API* регистрации приложения, чтобы регистрация приложения была допустимой:
    ...
    :::image type="content" source="media/how-to-create-app-registration/grant-admin-consent.png" alt-text="Представление портала кнопки &quot;предоставить согласие администратора&quot; в разделе &quot;разрешения API&quot;":::
  - Если согласие предоставлено успешно, запись для Azure Digital двойников должна отобразить значение *состояния* " _предоставлено **" (ваша компания)**_ .
    ...
    :::image type="content" source="media/how-to-create-app-registration/granted-admin-consent-done.png" alt-text="Представление портала согласия администратора, предоставленного для Организации в разделе &quot;разрешения API&quot;":::
