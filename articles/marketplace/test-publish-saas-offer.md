...
> [!NOTE]
> Рекомендуется создать отдельное предложение тестирования и разработки (DEV) для тестирования перед публикацией производственного предложения (Production). Выполните следующие действия, чтобы создать и протестировать предложение для разработки перед публикацией предложения (ПРОИЗВОДСТВЕННОго).
...
1. Чтобы проверить сквозной процесс покупки и настройки, приобретите планы в предложении, пока оно находится на этапе предварительной версии. Во-первых, сообщите корпорации Майкрософт запрос в [службу поддержки](https://aka.ms/marketplacesupport) , чтобы не обрабатывать оплату.
...
После завершения всех тестов в предварительной версии выберите **Go Live** , чтобы опубликовать предложение в коммерческом магазине. Если ваше предложение уже доступно в коммерческом магазине, все вносимые вами обновления будут работать только после выбора **Go Live**.

> [!IMPORTANT]
> Не выбирайте предложение **Go Live** для [предложения по разработке и тестированию](create-saas-dev-test-offer.md).
