...
Перед публикацией предложения следует использовать функции предварительной версии для разработки технической реализации, тестирования и экспериментов с различными моделями ценообразования.
