...
| Email | Электронная почта клиента | Адрес электронной почты, который указал клиент. Адрес электронной почты может отличаться от адреса электронной почты в подписке Azure клиента. | Email |
