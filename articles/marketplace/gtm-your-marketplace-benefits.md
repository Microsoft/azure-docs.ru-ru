...
Вы получите поддержку в понимании ресурсов, доступных для вас и в ходе реализации рекомендаций, которые также можно [Просмотреть самостоятельно](https://partner.microsoft.com/asset/collection/azure-marketplace-and-appsource-publisher-toolkit#/).

Подробное описание всех преимуществ программы можно найти в этой [программе в Marketplace](https://aka.ms/marketplacerewards).

## <a name="getting-started-is-easy"></a>Приступая к работе — это просто:
...
> [!NOTE]
> Если ваше предложение активно более четырех недель и вы не получили никаких сообщений, уточните в своей организации, кто является владельцем этого предложения (эту информацию можно найти в Центре партнеров). Сообщение и инструкции по дальнейшим действиям должны быть у этого человека.<br><br>Если вы не можете определить владельца или если владелец оставил вашу компанию, обратитесь в службу поддержки в [центре справки и поддержки](https://aka.ms/marketplacepublishersupport).
...
Каждый раз при публикации в Microsoft AppSource или Azure Marketplace вы получите доступ к новому набору преимуществ. Когда ваше предложение станет активным, перейдите в [Центр партнеров](https://partner.microsoft.com/dashboard) , чтобы активировать соответствующие маркетинговые, торговые и технические преимущества.

> [!IMPORTANT]
> Срок действия пробных и консультационных услуг истекает через три месяца.
...
Когда вы переходите в интерактивное предложение с помощью предложения в Microsoft AppSource или Azure Marketplace, вы можете получить доступ к дополнительным преимуществам по мере роста продаваемых счетов продаж или мест, проданных через коммерческий рынок.
...
### <a name="marketing-benefits-for-transact-offers"></a>Маркетинговые преимущества для предложений Transact

![Преимущества по маркетингу](./media/marketplace-publishers-guide/marketing-benefit.png)

### <a name="sales-benefits-for-transact-offers"></a>Преимущества продаж для предложений Transact

![Преимущества по продажам](./media/marketplace-publishers-guide/sales-benefit.png)

### <a name="technical-benefits-for-transact-offers"></a>Технические преимущества для предложений Transact
