...
| ------------ | ------------- | ------------- | ------------- |
| Дата | Дата посещения | Дата посещения страницы и/или ПНА щелкните Создание события на странице предложения в Azure Marketplace и/или AppSource. | Дата |
