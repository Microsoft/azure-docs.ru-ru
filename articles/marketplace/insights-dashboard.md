...
| ------------ | ------------- | ------------- | ------------- |
| Date | Дата посещения | Дата посещения страницы и/или ПНА щелкните Создание события на странице предложения в Azure Marketplace и/или AppSource. | Date |
| Название предложения | Название предложения | Имя предложения коммерческого рынка. | OfferName |
| Домен ссылок | Домен ссылок | Имя домена ссылок, из которого произошло посещение страницы. Если для посещения страницы не зарегистрированы ссылочные домены, то соответствующая запись называется "ссылочный домен отсутствует". |  реферралдомаин |
| Название страны | Название страны | Название страны, из которой было посещено посещение страницы. | CountryName |
| Посещения страниц | Посещения страниц | Количество посещений страниц, связанных с названием предложения для определенной даты. | пажевиситс |
| Получить сейчас | Получить сейчас | Количество переходов на страницу "получить сейчас" на странице предложения для определенной даты. | жетитнов |
| Связь со мной | Связь со мной | Количество переходов по адресу ПНА на странице предложения в течение определенной даты. | контактме |
| Тестовый выпуск | Тестовый выпуск | Число переходов к "тестовому диску" на странице предложения для определенной даты. | тестдриве |
| Пробная версия | Пробная версия | Число переходов на страницу "бесплатный пробный период" на странице предложения для определенной даты. | фритриал |
| Кампания | Название кампании | Возможность понимания веб-телеметрии (посещение страниц и щелчков ПНА) по названию кампании. | Кампания |
| Недоступно | Сайт | Имя витрины, из которой произошло посещение страницы или ПНА Click. Допустимые значения:<br><ul><li>азуремаркетплаце<li>APPSOURCE</ul> | Сайт |
|
