...
|**Гипермасштабирование**|Недоступно|Недоступно|Недоступно|&bull;&nbsp;Постоянная задержка во времени независимо от используемого пространства</br>&bull;&nbsp;Обычно менее 2 минут|
