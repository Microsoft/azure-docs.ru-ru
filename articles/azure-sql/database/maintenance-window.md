...
После выбора периода обслуживания и завершения настройки службы все запланированные обновления будут выполняться только в выбранном окне.   
...
Настройка и использование периода обслуживания предоставляется бесплатно для всех [типов предложений](https://azure.microsoft.com/support/legal/offer-details/): оплата по мере использования, поставщик облачных решений (CSP), Microsoft Enterprise или соглашение с клиентами Майкрософт.
...
Уведомления об обслуживании можно настроить для оповещения о предстоящих событиях запланированного обслуживания для базы данных SQL Azure за 24 часа, на момент обслуживания и после завершения периода обслуживания. Дополнительные сведения см. в разделе [предварительные уведомления](advance-notifications.md).
