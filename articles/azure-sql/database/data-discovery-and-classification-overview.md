...
- Сведения о классификации баз данных SQL Azure и Azure синапсе Analytics с метками зрения Azure с помощью команд T-SQL см. в статье [классификация данных SQL Azure с помощью меток зрения Azure](../../sql-database/scripts/sql-database-import-purview-labels.md).