...
> [!NOTE]
> `tempdb`Ограничения см. в разделе [ограничения tempdb](/sql/relational-databases/databases/tempdb-database#tempdb-database-in-sql-database).
