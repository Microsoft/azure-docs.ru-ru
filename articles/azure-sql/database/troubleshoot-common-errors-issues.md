...
| ---:| ---:|:--- |
| 4060 |16 |Невозможно открыть базу данных %.&#x2a;ls, запрашиваемую именем входа. Сбой при входе. Дополнительные сведения см. [в разделе ошибки с 4000 по 4999](/sql/relational-databases/errors-events/database-engine-events-and-errors#errors-4000-to-4999) .|
