...
1. В меню выберите пункт **файл** , а затем пункт **создать проект**. Укажите имя проекта, расположение для сохранения проекта. Выберите **базу данных SQL Azure** в качестве цели миграции. 
...
1. После завершения преобразования схемы Сравните преобразованный код с исходным кодом для выявления потенциальных проблем. 
   ...
   ![ Сравнение и проверка объекта ](./media/mysql-to-sql-database-guide/table-comparison.png)

   Сравните преобразованные процедуры с исходными процедурами: 

   ![Сравнение и проверка кода объекта](./media/mysql-to-sql-database-guide/procedure-comparison.png)
