...
Дополнительные сведения о дополнительных стратегиях миграции см. в статье [SQL Server Обзор миграции виртуальной машины](sql-server-to-sql-on-azure-vm-migration-overview.md). Другие руководства по миграции см. в разделе [Перенос базы данных](https://docs.microsoft.com/data-migration). 
