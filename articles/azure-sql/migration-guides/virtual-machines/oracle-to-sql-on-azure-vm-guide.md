...
1. После завершения проверки просмотрите сводный отчет по **сбору данных** . Сканирование может занять несколько минут и зависит от количества баз данных. По завершении нажмите кнопку **Закрыть** . 
...
1. Щелкните правой кнопкой мыши схему Oracle в **обозревателе метаданных Oracle** и выберите команду **преобразовать схему**.
