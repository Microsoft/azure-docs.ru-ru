...
- Использование [Azcopy](../../storage/common/storage-use-azcopy-v10.md) или [Обозреватель службы хранилища Azure](https://azure.microsoft.com/en-us/features/storage-explorer) для отправки резервных копий в контейнер больших двоичных объектов
...
В ходе этого ожидания команда не будет возвращать управление командной строке. Если вы создаете скрипт для процесса миграции и вам нужна команда LRS Start, чтобы немедленно вернуть управление к остальной части скрипта, можно запустить PowerShell как фоновое задание с `-AsJob` параметром. Например:
