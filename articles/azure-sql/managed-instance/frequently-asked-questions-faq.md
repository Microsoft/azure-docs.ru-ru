...
Вы можете удалить управляемые экземпляры с помощью портал Azure, [PowerShell](/powershell/module/az.sql/remove-azsqlinstance), [Azure CLI](/cli/azure/sql/mi#az-sql-mi-delete) или [Диспетчер ресурсов интерфейсов API](/rest/api/sql/managedinstances/delete).
...
[Репликацию транзакций](replication-two-instances-and-sql-server-configure-tutorial.md) можно использовать, если все таблицы в базе данных имеют *первичные* ключи и в базе данных нет объектов OLTP в памяти.
