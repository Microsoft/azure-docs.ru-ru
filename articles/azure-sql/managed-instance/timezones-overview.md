...
Укажите свойство Тимезонеид в [шаблоне диспетчер ресурсов](./create-template-quickstart.md) , чтобы задать часовой пояс во время создания экземпляра.
