...
| Параметр имени файла | Формат имени записанных данных. По умолчанию по одному файлу на раздел в формате `part-#####-tid-<guid>` | Нет | Шаблон: строка <br> На секцию: String [] <br> Имя файла в качестве данных столбца: строка <br> Вывод в один файл: `['<fileName>']` <br> Папка с именами в качестве данных столбца: строка | filePattern <br> партитионфиленамес <br> ровурлколумн <br> партитионфиленамес <br> ровфолдерурлколумн |
