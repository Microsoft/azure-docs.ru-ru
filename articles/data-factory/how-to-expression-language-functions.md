...
В этой статье мы рассмотрим основные понятия обучения с примерами и учебниками по созданию конвейеров параметризованных данных в фабрике данных Azure. Параметризация и динамические выражения — это важные дополнения к ADF, так как они могут сэкономить много времени и обеспечить гораздо более гибкое решение для извлечения, преобразования, загрузки (ETL) или извлечения, загрузки, преобразования (ELT), что позволит значительно сократить затраты на обслуживание решений и ускорить реализацию новых функций в существующих конвейерах. Эти преимущества обусловлены тем, что параметризация уменьшает объем жесткого кода и увеличивает количество многократно используемых объектов и процессов в решении.
