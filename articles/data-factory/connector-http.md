...
| authenticationType | Указывает тип проверки подлинности. Допустимые значения **Anonymous**, **Basic**, **Digest**, **Windows** и **ClientCertificate**. OAuth на основе пользователя не поддерживается. Кроме того, можно настроить заголовки проверки подлинности в `authHeader` свойстве. С дополнительными свойствами и примерами JSON этих типов проверки подлинности ознакомьтесь в последующих разделах этой таблицы. | Да |
