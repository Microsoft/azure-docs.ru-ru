...
Вы также можете подключить локальную сеть к виртуальной сети, настроив подключение VPN (сеть — сеть) по протоколу IPsec или подключение Azure ExpressRoute (частный пиринг). 
