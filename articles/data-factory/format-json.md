...
```
Если выбрано значение **документ на строку** , сопоставление потоков данных считывает один документ JSON из каждой строки в файле. 
...
File3.json
 ...
 {"time":"2015-04-29T07:13:21.4370000Z","callingimsi":"466923101048691","callingnum1":"678901578","callingnum2":"345626404","switch1":"Germany","switch2":"UK"}
```
Если выбран **массив документов** , сопоставление потоков данных считывает один массив документов из файла. 
