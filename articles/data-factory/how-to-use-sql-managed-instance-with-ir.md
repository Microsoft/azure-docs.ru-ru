...
1. Выберите способ подключения Управляемый экземпляр SQL, более частных конечных точек или более общей конечной точки:
    ...
    - Через частную конечную точку (рекомендуется).
        ...
        1. Выберите виртуальную сеть для присоединения Azure-SSIS IR:
            ...
            Дополнительные сведения о подключении к SQL Управляемый экземпляр см. в статье [Подключение приложения к Azure SQL управляемый экземпляр](../azure-sql/managed-instance/connect-application-instance.md).
