---
title: Руководство. Подключение примера кода устройства IoT Plug and Play к Центру Интернета вещей Azure | Документация Майкрософт
description: Руководство. Создание и запуск примера кода (C, C#, Java, JavaScript или Python) устройства IoT Plug and Play, который использует несколько компонентов и подключается к центру Интернета вещей. С помощью обозревателя Интернета вещей Azure просматривайте сведения, отправленные устройством в центр.
author: ericmitt
ms.author: ericmitt
ms.date: 07/22/2020
ms.topic: tutorial
...
ms.locfileid: "106061015"
---
# <a name="tutorial-connect-an-iot-plug-and-play-multiple-component-device-applications-running-on-linux-or-windows-to-iot-hub"></a>Руководство по подключению приложений устройства IoT Plug and Play с несколькими компонентами в Linux или Windows к Центру Интернета вещей
