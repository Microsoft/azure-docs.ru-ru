...
Кластеры Service Fabric Azure, которые работают в неизмененных версиях позже 6,3, будут испытывать потери функциональности или нарушения работы служб, если они не были обновлены до поддерживаемой версии до 19 января 2021.
 ...
 - **Для кластеров, работающих под управлением версии Service Fabric более 6,3 и использующих [функции Open Networking для контейнеров](./service-fabric-networking-modes.md#set-up-open-networking-mode)** , кластер может стать недоступным и прекратит работу, что может вызвать перерывы в работе службы для рабочих нагрузок.
 
 -   **Для кластеров с [версиями Windows между 7.0.457 и 7.0.466 (обе включенные версии)](#supported-version-names) и ОС Windows включена функция контейнеров Windows. Примечание. версии Linux 7.0.457, 7.0.464 и 7.0.465 не затрагиваются**.
...
| 7.1.409. * | 7.0.466. * |Меньше или равно версии 4,1 |31 июля 2021 г. |
| 7.1.417. * | 7.0.466. * |Меньше или равно версии 4,1 |31 июля 2021 г. |
| 7.1.428. * | 7.0.466. * |Меньше или равно версии 4,1 |31 июля 2021 г. |
| 7.1.456. * | 7.0.466. * |Меньше или равно версии 4,1 |31 июля 2021 г. |
| 7.1.458. * | 7.0.466. * |Меньше или равно версии 4,1 |31 июля 2021 г. |
| 7.1.459. * | 7.0.466. * |Меньше или равно версии 4,1 |31 июля 2021 г. |
| 7.1.503. * | 7.0.466. * |Меньше или равно версии 4,1 |31 июля 2021 г. |
| 7.1.510. * | 7.0.466. * |Меньше или равно версии 4,1 |31 июля 2021 г. |
...
| 7.2.477. * | 7.0.478. * |Меньше или равно версии 4,2 |Текущая версия, без даты окончания |
...
| 7,2 И НАКОПИТЕЛЬНЫМ | 7.2.477.9590 | 7.2.476.1 |