...
- **Путь к файлу конфигурации**: путь к файлу конфигурации. Вы можете просмотреть артефакт сборки, чтобы выбрать файл конфигурации. ( `...` кнопка справа от текстового поля). Поддерживаются следующие форматы файлов: YAML, JSON, Properties.
