...
Размер диска данных | До 8 192 ГБ при репликации на управляемый диск (9,26 версии)<br> До 4 095 ГБ при репликации в учетную запись хранения </br> Требования к минимальному размеру диска — не менее 1024 МБ| Если не поддерживается, проверка завершается ошибкой.
