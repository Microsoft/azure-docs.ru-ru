...
1. Скачайте и откройте [планировщик ресурсов Azure Site Recovery](/samples/browse/?redirectedfrom=TechNet-Gallery). Выполните макрос. Когда появится запрос, сделайте выбор, чтобы включить редактирование и содержимое.
