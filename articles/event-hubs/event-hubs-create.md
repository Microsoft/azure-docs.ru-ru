...
1. Введите имя концентратора событий, а затем выберите **Создать**.
    ...
    Параметр **Хранение сообщений** указывает, как долго служба "Центры событий" будет хранить данные. Дополнительные сведения см. в статье [Хранение событий](event-hubs-features.md#event-retention).
