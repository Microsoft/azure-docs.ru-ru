...
1. Создайте дополнительное пространство имен в другом регионе. Этот шаг является необязательным. Вы можете создать вторичное пространство имен при создании связывания на следующем шаге. 
...
1. На странице **Инициация связывания** выполните следующие действия.
    1. Выберите существующее вторичное пространство имен или создайте его в другом регионе. В этом примере выбрано существующее пространство имен.  
