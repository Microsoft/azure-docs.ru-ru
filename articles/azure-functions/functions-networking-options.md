...
Сейчас эта функция работает для всех номеров SKU, поддерживаемых виртуальной сетью Windows, в выделенном плане (служба приложений) и для плана Premium. План потребления не поддерживается. Сведения о настройке функции с учетной записью хранения, ограниченной для частной сети, см. в статье [ограничение учетной записи хранения виртуальной сети](configure-networking-how-to.md#restrict-your-storage-account-to-a-virtual-network).
...
Сведения об управлении исходящим IP-адресом с помощью виртуальной сети см. в разделе [учебник. Управление функциями Azure исходящий IP-адрес с использованием шлюза NAT виртуальной сети Azure](functions-how-to-use-nat-gateway.md). 
