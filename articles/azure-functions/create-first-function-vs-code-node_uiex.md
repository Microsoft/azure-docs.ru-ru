...
Ниже перечислены самые распространенные проблемы, которые приходится решать при создании локального проекта службы "Функции Azure".
...
<br/>
<details>
<summary><strong>Не удается запустить функцию локально?</strong></summary>

Ниже перечислены самые распространенные проблемы, которые приходится решать при выполнении локального проекта службы "Функции Azure".
...
Из этого раздела вы узнали, как создать ресурсы Azure и развернуть локальный код в виде приложения-функции. Если это сделать не удалось, выполните следующее:
...
* Публикация выполнялась в существующем приложении-функции? Это действие перезаписывает содержимое приложения в Azure.
</details>


<br/>
<details>
<summary><strong>Какие ресурсы были созданы?</strong></summary>
