...
Параметры конфигурации для [триггеров и привязок концентратора событий](functions-bindings-event-hubs.md#functions-1x).
...
|autoComplete|true|Если значение равно true, то триггер автоматически завершит обработку сообщения при успешном выполнении операции. Если значение равно "false", функция должна завершить сообщение перед возвратом.|
