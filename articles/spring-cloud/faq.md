...
Да. Дополнительные сведения см. в разделе [учебник. Использование распределенной трассировки с помощью Azure веснного облака](spring-cloud-howto-distributed-tracing.md).
