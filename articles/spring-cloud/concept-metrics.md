---
title: Метрики для Azure Spring Cloud
...
>| Имя | Имя метрики пружинного выключателя | Unit | Сведения |
>|------|-----------------------------|------|---------|
>| Загрузка ЦП       | Использование ЦП      | Процент      | Процент использования ЦП процессом относительно всех ресурсов ЦП системы [0-100]. |
