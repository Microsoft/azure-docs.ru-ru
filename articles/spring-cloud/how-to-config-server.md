...
В рамках этой статьи вы узнали, как включить и настроить экземпляр сервера конфигурации Spring Cloud. Дополнительные сведения об управлении приложением см. в статье [Масштабирование приложения в Azure Spring Cloud](spring-cloud-howto-scale-manual.md).
