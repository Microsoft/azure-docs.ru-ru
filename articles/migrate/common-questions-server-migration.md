...
| RHEL 8,1, 8,0, 7,8, 7,7, 7,6, 7,5, 7,4, 7,0, 6. x        | Y<br>                 _Для RHEL 8. x требуется [Подготовка вручную](./prepare-for-migration.md#linux-machines)_   | Да                              | Да                                                          |
| Цент ОС 8,1, 8,0, 7,7, 7,6, 7,5, 7,4, 6. x               | Y<br>_Для загрузки ОС 8. x требуется [Ручная подготовка](./prepare-for-migration.md#linux-machines)_ | Да                              | Да                                                          |
