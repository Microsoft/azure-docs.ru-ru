---
title: Оценка готовности физических серверов к миграции в Azure с помощью Миграции Azure
description: Узнайте, как оценивать готовность локальных физических серверов к миграции в Azure с помощью Миграции Azure.
author: rashi-ms
ms.author: rajosh
ms.manager: abhemraj
ms.topic: tutorial
...
В этой статье описывается, как оценивать готовность локальных физических серверов к миграции в Azure с помощью средства обнаружения и оценки Миграции Azure.
...
- Прежде чем приступить к работе с этим учебником по оценке серверов для миграции на виртуальные машины Azure, убедитесь, что обнаружили серверы, которые хотите оценить:
    - Чтобы обнаруживать сервера с помощью устройства службы "Миграция Azure", [выполните инструкции из этого учебника](tutorial-discover-physical.md). 
...
- Убедитесь, что физические серверы, которые вы хотите оценить, не работают под управлением Windows Server 2003 или SUSE Linux. Оценки не поддерживаются для этих серверов.
