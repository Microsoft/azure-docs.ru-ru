---
title: Оценка готовности экземпляров виртуальных машин GCP к миграции в Azure с помощью службы "Миграция Azure"
description: В этой статье описывается, как оценить готовность экземпляров виртуальных машин GCP к миграции в Azure с помощью службы "Миграция Azure".
author: rashi-ms
ms.author: rajosh
ms.manager: abhemraj
ms.topic: tutorial
...
В этой статье описывается, как оценить готовность экземпляров виртуальных машин Google Cloud Platform (GCP) к миграции в Azure с помощью средства "Обнаружение и оценка" службы "Миграция Azure".
...
Решите, следует ли выполнять оценку с помощью критериев определения размера, основанных на данных производительности или данных/метаданных конфигурации сервера, которые были собраны локально в исходном виде.
...
1. В разделе **Windows, Linux and SQL Server (Windows, Linux и SQL Server)**  > **Azure Migrate: Discovery and assessment** (Миграция Azure: Обнаружение и оценка) щелкните номер рядом с элементом **Оценки**.
