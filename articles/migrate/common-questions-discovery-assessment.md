...
## <a name="i-want-to-try-out-the-new-azure-sql-assessment-feature-in-azure-migrate"></a>Я хочу испытать новую функцию оценки Azure SQL в службе "Миграция Azure"
Чтобы опробовать эту функцию, воспользуйтесь [этой ссылкой](https://go.microsoft.com/fwlink/?linkid=2155668L) для создания проекта в регионе **Восточная Австралия**.
...
- Обратите внимание, что возможности обнаружения и оценки экземпляров и баз данных SQL Server, работающих в окружении VMware, сейчас предоставляются в предварительной версии.
