...
3. В **1. Создайте ключ проекта**, укажите имя для устройства миграции Azure, которое будет настроено для обнаружения серверов в среде VMware. Имя должно состоять из букв и цифр длиной не более 14 символов.
