---
title: Оценка готовности виртуальных машин Hyper-V к миграции в Azure с помощью Миграции Azure
description: Узнайте, как оценить готовность виртуальных машин Hyper-V к миграции в Azure с помощью Миграции Azure.
author: rashi-ms
ms.author: rajosh
ms.manager: abhemraj
ms.topic: tutorial
...
В этой статье описано, как оценивать готовность обнаруженных серверов из среды Hyper-V к миграции в на виртуальные машины Azure с помощью средства обнаружения и оценки Миграции Azure.
...
- Прежде чем приступить к работе с этим учебником по оценке серверов для миграции на виртуальные машины Azure, убедитесь, что обнаружили серверы, которые хотите оценить:
    - Чтобы обнаруживать сервера с помощью устройства службы "Миграция Azure", [выполните инструкции из этого учебника](tutorial-discover-hyper-v.md). 
