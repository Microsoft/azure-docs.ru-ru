...
Это известная проблема VMware, при которой размер диска, указанный моментальным снимком, становится нулевым. Следуйте разрешению, заданному в [VMware KB](https://kb.vmware.com/s/).
