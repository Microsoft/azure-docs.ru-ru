...
2. Агент виртуальных машин автоматически устанавливается для виртуальных машин Windows и Linux во время миграции. Ознакомьтесь с [требованиями](../virtual-machines/extensions/agent-linux.md#requirements) к агенту Linux для виртуальных машин Azure на перенесенных компьютерах, если на компьютере установлена ОС Linux, чтобы убедиться, что установка агента виртуальной машины Linux выполнена правильно. 
...
- Для повышения производительности:
    - По умолчанию при создании дисков данных для параметра кэширования узлов задано значение "Нет". Просмотрите параметры и настройте кэширование диска данных в соответствии с требованиями рабочей нагрузки. [Подробнее](../virtual-machines/premium-storage-performance.md#disk-caching).  
