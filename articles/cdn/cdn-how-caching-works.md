...
- При использовании в HTTP-ответе от клиента к POP CDN:
     ...
     - **Azure CDN Standard/Premium от Verizon** и **Azure CDN Standard от корпорации Майкрософт** учитывает поведение кэширования для директив Cache-Control в [RFC 7234-протоколе HTTP/1.1: Caching (ietf.org)](https://tools.ietf.org/html/rfc7234#section-5.2.2.8).
