...
3. В разделе с типом управления сертификатом выберите **Использовать собственный сертификат**. 
    ...
    :::image type="content" source="./media/cdn-custom-ssl/cdn-configure-your-certificate.png" alt-text="Снимок экрана: настройка сертификата для конечной точки CDN.":::
