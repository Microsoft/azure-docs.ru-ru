...
| Max-size | Максимальная длина текста запроса или ответа, проверенная по `Content-Length` заголовку. Если текст запроса или текст ответа сжаты, это значение является распакованной длиной. Максимально допустимое значение: 102 400 байт (100 КБ).  | Да       | Н/Д   |
...
| **имя**;                             | **Тип**                                                        | **Правило проверки** | **Подробные сведения**                                                                                                                                       | **Общедоступный ответ**                                                                                                                       | **Действие**           |
|----|----|---|---|---|----|
| **Проверка-содержимое** |                                                                 |                     |                                                                                                                                                   |                                                                                                                                           |                      |
