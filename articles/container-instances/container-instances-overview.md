...
Получите образы контейнеров Linux или Windows из Docker Hub, частного [реестра контейнеров Azure](../container-registry/index.yml) или из другого облачного реестра Docker. См. раздел [Вопросы и ответы](container-instances-faq.md), чтобы узнать, какие реестры поддерживаются ACI. Служба "Экземпляры контейнеров Azure" кэширует несколько распространенных базовых образов ОС, помогая ускорить развертывание пользовательских образов приложений.
...
Служба ACI хранит минимальный объем данных клиента, необходимый для надлежащей работы групп контейнеров. Возможность хранения данных клиентов в одном регионе сейчас доступна только для регионов "Юго-Восточная Азия" (Сингапур; Азиатско-Тихоокеанский географический регион) и "Южная Бразилия" (штат Сан-Паулу; Бразилия). Для всех других регионов данные клиента хранятся в [геообъектах](https://azure.microsoft.com/global-infrastructure/geographies/). Чтобы узнать больше, обратитесь в службу поддержки Azure.
