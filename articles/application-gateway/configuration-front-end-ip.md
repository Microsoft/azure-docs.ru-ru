...
Поддерживается только один общедоступный IP-адрес и один частный IP-адрес. При создании шлюза приложений вы выбираете IP-адрес внешнего интерфейса.
