...
1. После воспроизведения непредвиденного поведения портала выберите **сохранить все как HAR**.
...
1. Вернувшись на панель средства разработчика браузера, перейдите на вкладку **консоль** . Щелкните правой кнопкой мыши одно из сообщений, выберите пункт **экспортировать видимые сообщения в** и сохраните выходные данные консоли в текстовый файл.
