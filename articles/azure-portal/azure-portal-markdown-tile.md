...
1. В представлении "панель мониторинга" выберите панель мониторинга, в которой должна появиться настраиваемая плитка Markdown, а затем нажмите кнопку **изменить**.
