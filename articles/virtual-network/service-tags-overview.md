...
> [!NOTE] 
> По состоянию на март 2021 можно также использовать теги службы вместо явных диапазонов IP-адресов в [определяемых пользователем маршрутах](./virtual-networks-udr-overview.md). Эта функция сейчас доступна в виде общедоступной предварительной версии. 
