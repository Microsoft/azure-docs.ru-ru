...
- В портал Azure можно указать только одну группу безопасности приложений в качестве источника и назначения в правиле безопасности. В REST API (включая PowerShell/Azure CLI) можно указать несколько групп безопасности приложений в источнике или назначении.
