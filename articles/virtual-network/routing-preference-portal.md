...
1. Для номера SKU выберите **стандартный**.
1. Для параметра **Маршрутизация** выберите **Интернет**.

      ![Создание общедоступного IP-адреса](./media/routing-preference-portal/public-ip-new.png)
1. В разделе **Конфигурация IP-адреса IPv4** введите или выберите следующие сведения:

    | Параметр | Значение |
    | ------- | ----- |
    | Подписка | Выберите свою подписку.|
    | Группа ресурсов | Выберите **создать**, введите *раутингпреференцересаурцеграуп*, а затем нажмите кнопку **ОК**. |
    | Расположение | Выберите **Восточная часть США**.|
    | Зона доступности | Используйте значение по умолчанию — **избыточный** в виде зоны. |
