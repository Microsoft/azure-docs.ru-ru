...
- Доступ к управляемым учетным записям хранения прекратил работу после применения политики конечной точки службы к подсети.
  - Управляемые учетные записи хранения не поддерживаются политиками конечной точки службы. При настройке политики по умолчанию запрещает доступ ко всем управляемым учетным записям хранения. Если приложению требуется доступ к управляемым учетным записям хранения, политики конечных точек не следует использовать для этого трафика.
