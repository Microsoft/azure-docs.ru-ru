...
Дополнительные сведения см. в документации по [AZ ML Service Update](/cli/azure/ext/azure-cli-ml/ml/service#ext-azure-cli-ml-az-ml-service-update) .
