...
ms.locfileid: "104607835"
---
# <a name="azure-security-baseline-for-azure-machine-learning"></a>Базовый план безопасности Azure для Машинное обучение Azure

Этот базовый план безопасности применяет рекомендации из [теста безопасности Azure версии 1,0](../security/benchmarks/overview-v1.md) к машинное обучение Microsoft Azure. Azure Security Benchmark содержит рекомендации по обеспечению безопасности облачных решений в Azure.
Содержимое группируются по **элементам управления безопасностью** , определенным в производительности системы безопасности Azure, и связанным рекомендациям, применимым к машинное обучение Azure. **Элементы управления** , неприменимые к машинное обучение Azure, были исключены.

 
Сведения о том, как Машинное обучение Azure полностью сопоставлены с тестовым показателем безопасности Azure, см. в разделе [полное машинное обучение Azure файла сопоставления базовых показателей безопасности](https://github.com/MicrosoftDocs/SecurityBenchmarks/tree/master/Azure%20Offer%20Security%20Baselines).
...
- [Настройка журналов диагностики для Машинное обучение Azure](https://docs.microsoft.com/azure/machine-learning/monitor-azure-machine-learning#configuration)
...
- [Выполнение запросов для Машинное обучение Azure в рабочих областях Log Analytics](https://docs.microsoft.com/azure/machine-learning/monitor-azure-machine-learning#analyzing-log-data)
...
- [Дополнительные сведения об оповещениях Машинное обучение Azure](https://docs.microsoft.com/azure/machine-learning/monitor-azure-machine-learning#alerts)
...
- [Настройка расширения антивредоносной программы Майкрософт для облачных служб](/powershell/module/servicemanagement/azure.service/set-azurevmmicrosoftantimalwareextension)
...
- [Дополнительные сведения о Машинное обучение ролях по умолчанию](https://docs.microsoft.com/azure/machine-learning/how-to-assign-roles#default-roles)

- [Дополнительные сведения о управление привилегированными пользователями](/azure/active-directory/privileged-identity-management/index)
...
**Руководство**. машинное обучение интегрировано с Azure Active Directory (Azure AD), используйте единый вход Azure AD вместо настройки отдельных автономных учетных данных для каждой службы. Использование удостоверений центра безопасности Azure и рекомендаций по доступу.
...
- [Машинное обучение Azure шифрование неактивных данных](https://docs.microsoft.com/azure/machine-learning/concept-enterprise-security#encryption-at-rest)
...
Машинное обучение Azure поддерживает различные ресурсы вычислений и даже собственные ресурсы вычислений. Для ресурсов вычислений, принадлежащих вашей организации, используйте настройку состояния службы автоматизации Azure для узлов DSC в любом облачном или локальном центре обработки данных. Вы можете легко подключать компьютеры, назначать им декларативные конфигурации и просматривать отчеты, показывающие соответствие каждого компьютера указанному вами состоянию. 
...
- [Машинное обучение Azure ключи, управляемые клиентом](https://docs.microsoft.com/azure/machine-learning/concept-enterprise-security#azure-blob-storage)
...
- [Восстановление ключей Key Vault в Azure](/powershell/module/az.keyvault/restore-azkeyvaultkey)
...
**Руководство**. для локальной архивации шифрование неактивных данных предоставляется с помощью парольной фразы, которую вы указали при резервном копировании в Azure. Используйте управление доступом на основе ролей Azure (Azure RBAC) для защиты резервных копий и ключей, управляемых клиентом. 
...
- [Включение обратимого удаления и очистки защиты в Key Vault](../storage/blobs/soft-delete-blob-overview.md)
