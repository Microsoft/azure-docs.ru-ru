...
При создании ресурсов для Машинное обучение Azure рабочей области также создаются ресурсы для других служб Azure. Их можно сформулировать следующим образом.
