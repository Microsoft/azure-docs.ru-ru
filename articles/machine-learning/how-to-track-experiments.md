...
Используйте следующие методы в API ведения журнала, чтобы повлиять на визуализации метрик. Обратите внимание на [ограничения службы](./resource-limits-quotas-capacity.md#metrics) для этих зарегистрированных метрик. 
