...
Создание и администрирование пулов Apache Spark в рабочей области Azure синапсе Analytics. Чтобы интегрировать пул Apache Spark с рабочей областью Машинное обучение Azure, необходимо [создать ссылку на рабочую область Azure синапсе Analytics](how-to-link-synapse-ml-workspaces.md). 
