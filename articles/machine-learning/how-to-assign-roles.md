...
- В настоящее время [Условный доступ](../role-based-access-control/conditional-access-azure-management.md) не поддерживается для машинное обучение Azure.
