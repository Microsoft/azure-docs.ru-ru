...
## <a name="understand-connectivity-requirements-for-aks-inferencing-cluster"></a>Общие сведения о требованиях к подключению для кластера вывода AKS
...
>
> Чтобы получить маркер, необходимо использовать пакет SDK для Машинное обучение Azure или команду [AZ ML Service Get-Access-Token](/cli/azure/ext/azure-cli-ml/ml/service#ext-azure-cli-ml-az-ml-service-get-access-token) .
