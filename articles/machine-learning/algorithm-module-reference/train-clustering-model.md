...
> [!NOTE]
> Если необходимо развернуть обученную модель в конструкторе, убедитесь, что [назначение данных кластерам](assign-data-to-clusters.md) вместо **модели оценки** подключено к входному [модулю вывода веб-службы](web-service-input-output.md) в конвейере вывода.
