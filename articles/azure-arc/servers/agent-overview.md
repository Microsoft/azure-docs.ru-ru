...
Метаданные о подключенном компьютере собираются после того, как агент подключенного компьютера регистрируется на серверах с поддержкой ARC. В частности, внесены следующие изменения.
...
* Чтобы подключить компьютеры, вы являетесь членом роли " **Подключение к подключенному компьютеру Azure** " или " [участник](../../role-based-access-control/built-in-roles.md#contributor) " в группе ресурсов.

* Для чтения, изменения и удаления компьютера вы являетесь членом роли **администратора ресурсов подключенного компьютера Azure** в группе ресурсов.

* Чтобы выбрать группу ресурсов из раскрывающегося списка при использовании метода **создания скрипта** , как минимум вы являетесь членом роли [читателя](../../role-based-access-control/built-in-roles.md#reader) для этой группы ресурсов.
